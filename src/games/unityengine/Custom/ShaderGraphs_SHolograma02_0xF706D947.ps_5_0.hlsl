  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.w = cb0[62].z * v1.y;
  r2.w = cb0[61].z * v1.x + r2.w;
  r2.w = cb0[63].z * v1.z + r2.w;
  r2.w = cb0[64].z + r2.w;
  r2.w = -cb0[17].y + -r2.w;
  r2.w = max(0, r2.w);
  r2.w = cb0[55].x * r2.w;
  ...
  if (r0.w != 0) {
    ...
    r0.w = r12.y * r7.z;
    r3.w = t3.SampleCmpLevelZero(s3_s, r10.xy, r4.z).x;
    r4.w = t3.SampleCmpLevelZero(s3_s, r10.zw, r4.z).x;
    r4.w = r13.y * r4.w;
    r3.w = r13.x * r3.w + r4.w;
    r4.w = t3.SampleCmpLevelZero(s3_s, r6.zw, r4.z).x;
    r3.w = r13.z * r4.w + r3.w;
    r4.w = t3.SampleCmpLevelZero(s3_s, r9.xy, r4.z).x;
    r3.w = r13.w * r4.w + r3.w;
    r4.w = t3.SampleCmpLevelZero(s3_s, r11.xy, r4.z).x;
    r3.w = r14.x * r4.w + r3.w;
    r4.w = t3.SampleCmpLevelZero(s3_s, r11.zw, r4.z).x;
    r3.w = r14.y * r4.w + r3.w;
    r4.w = t3.SampleCmpLevelZero(s3_s, r9.zw, r4.z).x;
    r3.w = r14.z * r4.w + r3.w;
    r4.w = t3.SampleCmpLevelZero(s3_s, r8.xy, r4.z).x;
    r3.w = r14.w * r4.w + r3.w;
    r4.w = t3.SampleCmpLevelZero(s3_s, r8.zw, r4.z).x;
    r0.w = r0.w * r4.w + r3.w;
  } else {
    r0.w = t3.SampleCmpLevelZero(s3_s, r4.xy, r4.z).x;
  }
  r3.w = 1 + -cb3[29].x;
  r0.w = r0.w * cb3[29].x + r3.w;
  r3.w = cmp(0 >= r4.z);
  r4.x = cmp(r4.z >= 1);
  ...
  r4.x = saturate(r3.w * cb3[29].z + cb3[29].w);
  r4.y = 1 + -r0.w;
  r0.w = r4.x * r4.y + r0.w;
  ...
  r5.w = -r6.x + r5.w;
  r6.x = cmp(0 < cb2[21].w);
  r6.y = cmp(cb2[21].w == 0.000000);
  r6.z = cmp(r5.w < -9.99999975e-05);
  r6.z = r6.z ? r6.y : 0;
  ...
  r6.yzw = -cb2[18].xyz + v1.xyz;
  r7.xyz = cb2[17].xyz + -v1.xyz;
  r6.yzw = min(r7.xyz, r6.yzw);
  r6.yzw = r6.yzw / cb2[17].www;
  r6.z = min(r6.z, r6.w);
  r6.y = saturate(min(r6.y, r6.z));
  r7.xyz = -cb2[21].xyz + v1.xyz;
  r8.xyz = cb2[20].xyz + -v1.xyz;
  r7.xyz = min(r8.xyz, r7.xyz);
  r7.xyz = r7.xyz / cb2[20].www;
  r6.z = min(r7.y, r7.z);
  r6.z = saturate(min(r7.x, r6.z));
  r6.w = 1 + -r6.z;
  r6.w = min(r6.y, r6.w);
  r5.w = r5.w ? r6.w : r6.y;
  r6.y = 1 + -r6.y;
  ...
  if (r6.z != 0) {
    ...
    r7.xyz = r6.zzz ? r7.xyz : r4.xyz;
    r7.xyzw = t1.SampleLevel(s1_s, r7.xyz, 4.05000019).xyzw;
    r6.z = -1 + r7.w;
    r6.z = cb2[15].w * r6.z + 1;
    r6.z = max(0, r6.z);
    r6.z = log2(r6.z);
    r6.z = cb2[15].y * r6.z;
    r6.z = exp2(r6.z);
  ...
  r5.w = cmp(0.00999999978 < r6.x);
  if (r5.w != 0) {
    r5.w = cmp(0 < cb2[22].w);
    r8.xyz = cmp(float3(0,0,0) < r4.xyz);
    r8.xyz = r8.xyz ? cb2[20].xyz : cb2[21].xyz;
    r8.xyz = -v1.xyz + r8.xyz;
    r8.xyz = r8.xyz / r4.xyz;
    r6.z = min(r8.x, r8.y);
    r6.z = min(r6.z, r8.z);
    r8.xyz = -cb2[22].xyz + v1.xyz;
    r8.xyz = r4.xyz * r6.zzz + r8.xyz;
    r8.xyz = r5.www ? r8.xyz : r4.xyz;
    ...
    r7.xyz = r6.xxx * r8.xyz + r7.xyz;
  }
  r5.w = cmp(r6.y < 0.99000001);
  if (r5.w != 0) {
    r8.xyzw = t0.SampleLevel(s0_s, r4.xyz, 4.05000019).xyzw;
    r4.x = 1 + -r6.y;
    r4.y = -1 + r8.w;
    r4.y = cb0[3].w * r4.y + 1;
    r4.y = max(0, r4.y);
    ...
    r4.y = exp2(r4.y);
    r4.y = cb0[3].x * r4.y;
    r6.xyz = r4.yyy * r8.xyz;
    r7.xyz = r4.xxx * r6.xyz + r7.xyz;
  }
  r4.x = r4.w * 0.5 + 0.0399999991;
  r4.x = 0.941176474 * r4.x;
  r4.xyz = r7.xyz * r4.xxx;
  r4.xyz = r5.xyz * r2.xyz + r4.xyz;
  r0.w = cb2[11].z * r0.w;
  r4.w = saturate(dot(r0.xyz, cb0[5].xyz));
  r0.w = r4.w * r0.w;
  ...
  while (true) {
    ...
    r4.w = (uint)r3.w >> 2;
    r5.w = (int)r3.w & 3;
    r4.w = dot(cb2[r4.w+12].xyzw, icb[r5.w+0].xyzw);
    r4.w = (int)r4.w;
    r8.xyz = -v1.xyz * cb1[r4.w+0].www + cb1[r4.w+0].xyz;
    r5.w = dot(r8.xyz, r8.xyz);
    r5.w = max(6.10351562e-05, r5.w);
    r6.w = rsqrt(r5.w);
    r9.xyz = r8.xyz * r6.www;
    r7.w = rcp(r5.w);
    r5.w = cb1[r4.w+512].x * r5.w;
    r5.w = -r5.w * r5.w + 1;
    r5.w = max(0, r5.w);
    r5.w = r5.w * r5.w;
    r5.w = r7.w * r5.w;
    r7.w = dot(cb1[r4.w+768].xyz, r9.xyz);
    r7.w = saturate(r7.w * cb1[r4.w+512].z + cb1[r4.w+512].w);
    r7.w = r7.w * r7.w;
    r5.w = r7.w * r5.w;
    r7.w = (int)cb4[r4.w+0].w;
    r8.w = cmp((int)r7.w >= 0);
    if (r8.w != 0) {
      r8.w = cmp(0 != cb4[r4.w+0].z);
      if (r8.w != 0) {
        ...
        r8.w = r8.w ? r10.x : r9.w;
        r9.w = trunc(cb4[r4.w+0].w);
        r8.w = r9.w + r8.w;
        r7.w = (int)r8.w;
      }
      r7.w = (uint)r7.w << 2;
      r10.xyzw = cb4[r7.w+257].xyzw * v1.yyyy;
      r10.xyzw = cb4[r7.w+256].xyzw * v1.xxxx + r10.xyzw;
      r10.xyzw = cb4[r7.w+258].xyzw * v1.zzzz + r10.xyzw;
      r10.xyzw = cb4[r7.w+259].xyzw + r10.xyzw;
      r10.xyz = r10.xyz / r10.www;
      r7.w = cmp(0.000000 != cb4[r4.w+0].y);
      if (r7.w != 0) {
        ...
        r7.w = r17.y * r12.z;
        r8.w = t4.SampleCmpLevelZero(s4_s, r15.xy, r10.z).x;
        r9.w = t4.SampleCmpLevelZero(s4_s, r15.zw, r10.z).x;
        r9.w = r18.y * r9.w;
        r8.w = r18.x * r8.w + r9.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r11.zw, r10.z).x;
        r8.w = r18.z * r9.w + r8.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r14.xy, r10.z).x;
        r8.w = r18.w * r9.w + r8.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r16.xy, r10.z).x;
        r8.w = r19.x * r9.w + r8.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r16.zw, r10.z).x;
        r8.w = r19.y * r9.w + r8.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r14.zw, r10.z).x;
        r8.w = r19.z * r9.w + r8.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r13.xy, r10.z).x;
        r8.w = r19.w * r9.w + r8.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r13.zw, r10.z).x;
        r7.w = r7.w * r9.w + r8.w;
      } else {
        r7.w = t4.SampleCmpLevelZero(s4_s, r10.xy, r10.z).x;
      }
      r8.w = -cb4[r4.w+0].x + 1;
      r7.w = r7.w * cb4[r4.w+0].x + r8.w;
      r8.w = cmp(0 >= r10.z);
      r9.w = cmp(r10.z >= 1);
    ...
    r5.w = r7.w * r5.w;
    r10.xyz = cb1[r4.w+256].xyz * r5.www;
    r8.xyz = r8.xyz * r6.www + r3.xyz;
    ...
    r4.w = 3 * r4.w;
    r4.w = 0.0625 / r4.w;
    r8.xyz = r4.www * float3(0.0399999991,0.0399999991,0.0399999991) + r2.xyz;
    r7.xyz = r8.xyz * r10.xyz + r7.xyz;
    r3.w = (int)r3.w + 1;
  }
  r0.xyz = r6.xyz * r5.xyz + r4.xyz;
  r0.xyz = r0.xyz + r7.xyz;
  r0.xyz = cb5[3].xyz * r1.yzw + r0.xyz;
  r0.w = -r2.w * r2.w;
  r0.w = exp2(r0.w);
  r0.xyz = -cb0[56].xyz + r0.xyz;
  o0.xyz = r0.www * r0.xyz + cb0[56].xyz;
