  ...
  out float4 o0 : SV_Target0)
{
  ...
  while (true) {
    ...
    r2.w = frac(r2.w);
    r5.z = r2.w * 2 + -1;
    r2.w = dot(r4.xy, float2(1,78.2330017));
    r2.w = sin(r2.w);
    r2.w = 43758.5469 * r2.w;
    r2.w = frac(r2.w);
    r2.w = r2.w + r0.x;
