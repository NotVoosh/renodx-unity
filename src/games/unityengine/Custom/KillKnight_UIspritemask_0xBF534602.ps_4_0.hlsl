  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = cb0[8].y * r0.x;
  r0.x = max(r0.x, r1.z);
  r0.yzw = saturate(r1.xyw);
  r1.z = dot(r0.yzw, float3(0.300000012,0.589999974,0.109999999));
  r0.yzw = -cb0[13].xyz + r0.yzw;
  r1.z = saturate(cb0[14].y + r1.z);
  r2.xyz = r1.zzz * cb0[12].xyz + -r1.xyw;
  ...
  r0.xy = frac(r0.xy);
  r0.x = r0.z * r0.x;
  r0.x = r0.x * cb0[6].x + v0.y;
  r0.z = cb0[5].y + cb0[5].w;
  r0.w = r0.x * r0.z;
  r0.w = cmp(r0.w >= -r0.w);
  r0.w = r0.w ? r0.z : -r0.z;
  r1.x = 1 / r0.w;
  ...
  r0.w = saturate(cb0[6].y);
  r0.w = -cb0[5].z + r0.w;
  r0.x = r0.x * r0.w + cb0[5].z;
  r0.w = 1 + -r0.x;
  r0.x = r0.z * r0.w + r0.x;
  r1.w = r3.w * r0.x;
  r1.xyzw = r1.xyzw + -r3.xyzw;
  r1.xyzw = cb0[6].zzzz * r1.xyzw + r3.xyzw;
  r0.x = 1 + -cb0[9].y;
  r0.x = cmp(r0.x >= r0.y);
