  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.w = dot(r4.xyzw, cb0[7].xyzw);
  r2.w = 1 + r2.w;
  r6.xyz = -cb0[16].xyz + v1.xyz;
  r3.w = dot(r6.xyz, r6.xyz);
  r5.w = saturate(r3.w * cb3[29].z + cb3[29].w);
  r2.w = r2.w + -r0.w;
  r0.w = r5.w * r2.w + r0.w;
  r2.w = dot(-r3.xyz, r0.xyz);
  r2.w = r2.w + r2.w;
  r6.xyz = r0.xyz * -r2.www + -r3.xyz;
  r2.w = saturate(dot(r0.xyz, r3.xyz));
  r2.w = 1 + -r2.w;
  r2.w = r2.w * r2.w;
  r2.w = r2.w * r2.w;
  r7.xyz = -cb2[18].xyz + cb2[17].xyz;
  r5.w = dot(r7.xyz, r7.xyz);
  r7.xyz = -cb2[21].xyz + cb2[20].xyz;
  r6.w = dot(r7.xyz, r7.xyz);
  r5.w = -r6.w + r5.w;
  r6.w = cmp(0 < cb2[21].w);
  r7.x = cmp(cb2[21].w == 0.000000);
  r7.y = cmp(r5.w < -9.99999975e-05);
  r7.y = r7.y ? r7.x : 0;
  r6.w = (int)r6.w | (int)r7.y;
  r7.y = cmp(cb2[21].w < 0);
  r5.w = cmp(9.99999975e-05 < r5.w);
  r5.w = r5.w ? r7.x : 0;
  r5.w = (int)r5.w | (int)r7.y;
  r7.xyz = -cb2[18].xyz + v1.xyz;
  r8.xyz = cb2[17].xyz + -v1.xyz;
  r7.xyz = min(r8.xyz, r7.xyz);
  r7.xyz = r7.xyz / cb2[17].www;
  r7.y = min(r7.y, r7.z);
  r7.x = saturate(min(r7.x, r7.y));
  r7.yzw = -cb2[21].xyz + v1.xyz;
  r8.xyz = cb2[20].xyz + -v1.xyz;
  r7.yzw = min(r8.xyz, r7.yzw);
  r7.yzw = r7.yzw / cb2[20].www;
  r7.z = min(r7.z, r7.w);
  r7.y = saturate(min(r7.y, r7.z));
  r7.z = 1 + -r7.y;
  r7.z = min(r7.x, r7.z);
  r5.w = r5.w ? r7.z : r7.x;
  r7.x = 1 + -r7.x;
  ...
  r5.w = r5.w / r7.y;
  r6.w = r6.w / r7.y;
  r7.y = cmp(0.00999999978 < r5.w);
  if (r7.y != 0) {
    r7.y = cmp(0 < cb2[19].w);
    r8.xyz = cmp(float3(0,0,0) < r6.xyz);
    r8.xyz = r8.xyz ? cb2[17].xyz : cb2[18].xyz;
    r8.xyz = -v1.xyz + r8.xyz;
    r8.xyz = r8.xyz / r6.xyz;
    r7.z = min(r8.x, r8.y);
    r7.z = min(r7.z, r8.z);
    r8.xyz = -cb2[19].xyz + v1.xyz;
    r8.xyz = r6.xyz * r7.zzz + r8.xyz;
    r7.yzw = r7.yyy ? r8.xyz : r6.xyz;
    r8.xyzw = t1.SampleLevel(s1_s, r7.yzw, 4.05000019).xyzw;
    r7.y = -1 + r8.w;
    r7.y = cb2[15].w * r7.y + 1;
    r7.y = max(0, r7.y);
    r7.y = log2(r7.y);
    r7.y = cb2[15].y * r7.y;
    r7.y = exp2(r7.y);
  ...
  r5.w = cmp(0.00999999978 < r6.w);
  if (r5.w != 0) {
    r5.w = cmp(0 < cb2[22].w);
    r8.xyz = cmp(float3(0,0,0) < r6.xyz);
    r8.xyz = r8.xyz ? cb2[20].xyz : cb2[21].xyz;
    r8.xyz = -v1.xyz + r8.xyz;
    r8.xyz = r8.xyz / r6.xyz;
    r8.x = min(r8.x, r8.y);
    r8.x = min(r8.x, r8.z);
    r8.yzw = -cb2[22].xyz + v1.xyz;
    r8.xyz = r6.xyz * r8.xxx + r8.yzw;
    r8.xyz = r5.www ? r8.xyz : r6.xyz;
    r8.xyzw = t2.SampleLevel(s2_s, r8.xyz, 4.05000019).xyzw;
    r5.w = -1 + r8.w;
    r5.w = cb2[16].w * r5.w + 1;
    r5.w = max(0, r5.w);
    r5.w = log2(r5.w);
    r5.w = cb2[16].y * r5.w;
    r5.w = exp2(r5.w);
    ...
    r7.yzw = r6.www * r8.xyz + r7.yzw;
  }
  r5.w = cmp(r7.x < 0.99000001);
  if (r5.w != 0) {
    r6.xyzw = t0.SampleLevel(s0_s, r6.xyz, 4.05000019).xyzw;
    r5.w = 1 + -r7.x;
    r6.w = -1 + r6.w;
    r6.w = cb0[3].w * r6.w + 1;
    r6.w = max(0, r6.w);
    ...
    r7.yzw = r5.www * r6.xyz + r7.yzw;
  }
  r2.w = r2.w * 0.5 + 0.0399999991;
  r2.xyzw = float4(0.959999979,0.959999979,0.959999979,0.941176474) * r2.xyzw;
  r6.xyz = r7.yzw * r2.www;
  r5.xyz = r5.xyz * r2.xyz + r6.xyz;
  r0.w = cb2[11].z * r0.w;
  r2.w = saturate(dot(r0.xyz, cb0[5].xyz));
  r0.w = r2.w * r0.w;
  r6.xyz = cb0[6].xyz * r0.www;
  r7.xyz = v5.xyz * r1.xxx + cb0[5].xyz;
  r0.w = dot(r7.xyz, r7.xyz);
  r0.w = max(1.17549435e-38, r0.w);
  r0.w = rsqrt(r0.w);
  r7.xyz = r7.xyz * r0.www;
  r0.w = saturate(dot(r0.xyz, r7.xyz));
  r1.x = saturate(dot(cb0[5].xyz, r7.xyz));
  r0.w = r0.w * r0.w;
  ...
  r0.w = 3 * r0.w;
  r0.w = 0.0625 / r0.w;
  r7.xyz = r0.www * float3(0.0399999991,0.0399999991,0.0399999991) + r2.xyz;
  r0.w = min(cb2[11].y, cb0[10].x);
  r0.w = (int)r0.w;
  r1.x = saturate(r3.w * cb4[1284].x + cb4[1284].y);
  r8.xyz = float3(0,0,0);
  r2.w = 0;
  while (true) {
    ...
    r3.w = (int)r3.w;
    r9.xyz = -v1.xyz * cb1[r3.w+0].www + cb1[r3.w+0].xyz;
    ...
    r5.w = r5.w * r5.w;
    r5.w = r7.w * r5.w;
    r7.w = dot(cb1[r3.w+768].xyz, r10.xyz);
    r7.w = saturate(r7.w * cb1[r3.w+512].z + cb1[r3.w+512].w);
    r7.w = r7.w * r7.w;
    r5.w = r7.w * r5.w;
    r7.w = (int)cb4[r3.w+0].w;
    r8.w = cmp((int)r7.w >= 0);
    if (r8.w != 0) {
      r8.w = cmp(0 != cb4[r3.w+0].z);
      if (r8.w != 0) {
        r11.xyz = cmp(abs(r10.zzy) >= abs(r10.xyx));
        r8.w = r11.y ? r11.x : 0;
        r11.xyw = cmp(-r10.zyx < float3(0,0,0));
        r11.xy = r11.xy ? float2(5,3) : float2(4,2);
        r9.w = r11.w ? 1.000000 : 0;
        r9.w = r11.z ? r11.y : r9.w;
        r8.w = r8.w ? r11.x : r9.w;
        r9.w = trunc(cb4[r3.w+0].w);
        r8.w = r9.w + r8.w;
        r7.w = (int)r8.w;
      }
      r7.w = (uint)r7.w << 2;
      r11.xyzw = cb4[r7.w+257].xyzw * v1.yyyy;
      r11.xyzw = cb4[r7.w+256].xyzw * v1.xxxx + r11.xyzw;
      r11.xyzw = cb4[r7.w+258].xyzw * v1.zzzz + r11.xyzw;
      r11.xyzw = cb4[r7.w+259].xyzw + r11.xyzw;
      r11.xyz = r11.xyz / r11.www;
      r7.w = cmp(0.000000 != cb4[r3.w+0].y);
      if (r7.w != 0) {
        r12.xy = r11.xy * cb4[1285].zw + float2(0.5,0.5);
        r12.xy = floor(r12.xy);
        r12.zw = r11.xy * cb4[1285].zw + -r12.xy;
        r13.xyzw = float4(0.5,1,0.5,1) + r12.zzww;
        r14.xyzw = r13.xxzz * r13.xxzz;
        r13.xz = float2(0.0799999982,0.0799999982) * r14.yw;
        r14.xy = r14.xz * float2(0.5,0.5) + -r12.zw;
        r14.zw = float2(1,1) + -r12.zw;
        r15.xy = min(float2(0,0), r12.zw);
        r15.xy = -r15.xy * r15.xy + r14.zw;
        r12.zw = max(float2(0,0), r12.zw);
        r12.zw = -r12.zw * r12.zw + r13.yw;
        r15.xy = float2(1,1) + r15.xy;
        r12.zw = float2(1,1) + r12.zw;
        r16.xy = float2(0.159999996,0.159999996) * r14.xy;
        r14.xy = float2(0.159999996,0.159999996) * r14.zw;
        r15.xy = float2(0.159999996,0.159999996) * r15.xy;
        r17.xy = float2(0.159999996,0.159999996) * r12.zw;
        r12.zw = float2(0.159999996,0.159999996) * r13.yw;
        r16.z = r15.x;
        r16.w = r12.z;
        r14.z = r17.x;
        r14.w = r13.x;
        r18.xyzw = r16.zwxz + r14.zwxz;
        r15.z = r16.y;
        r15.w = r12.w;
        r17.z = r14.y;
        r17.w = r13.z;
        r13.xyz = r17.zyw + r15.zyw;
        r14.xyz = r14.xzw / r18.zwy;
        r14.xyz = float3(-2.5,-0.5,1.5) + r14.xyz;
        r15.xyz = r17.zyw / r13.xyz;
        r15.xyz = float3(-2.5,-0.5,1.5) + r15.xyz;
        r14.xyz = cb4[1285].xxx * r14.yxz;
        r15.xyz = cb4[1285].yyy * r15.xyz;
        r14.w = r15.x;
        r16.xyzw = r12.xyxy * cb4[1285].xyxy + r14.ywxw;
        r12.zw = r12.xy * cb4[1285].xy + r14.zw;
        r15.w = r14.y;
        r14.yw = r15.yz;
        r17.xyzw = r12.xyxy * cb4[1285].xyxy + r14.xyzy;
        r15.xyzw = r12.xyxy * cb4[1285].xyxy + r15.wywz;
        r14.xyzw = r12.xyxy * cb4[1285].xyxy + r14.xwzw;
        r19.xyzw = r18.zwyz * r13.xxxy;
        r20.xyzw = r18.xyzw * r13.yyzz;
        r7.w = r18.y * r13.z;
        r8.w = t4.SampleCmpLevelZero(s4_s, r16.xy, r11.z).x;
        r9.w = t4.SampleCmpLevelZero(s4_s, r16.zw, r11.z).x;
        r9.w = r19.y * r9.w;
        r8.w = r19.x * r8.w + r9.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r12.zw, r11.z).x;
        r8.w = r19.z * r9.w + r8.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r15.xy, r11.z).x;
        r8.w = r19.w * r9.w + r8.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r17.xy, r11.z).x;
        r8.w = r20.x * r9.w + r8.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r17.zw, r11.z).x;
        r8.w = r20.y * r9.w + r8.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r15.zw, r11.z).x;
        r8.w = r20.z * r9.w + r8.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r14.xy, r11.z).x;
        r8.w = r20.w * r9.w + r8.w;
        r9.w = t4.SampleCmpLevelZero(s4_s, r14.zw, r11.z).x;
        r7.w = r7.w * r9.w + r8.w;
      } else {
        r7.w = t4.SampleCmpLevelZero(s4_s, r11.xy, r11.z).x;
      }
      r8.w = -cb4[r3.w+0].x + 1;
      r7.w = r7.w * cb4[r3.w+0].x + r8.w;
      r8.w = cmp(0 >= r11.z);
      r9.w = cmp(r11.z >= 1);
    ...
    r8.w = dot(r4.xyzw, cb1[r3.w+1024].xyzw);
    r8.w = 1 + r8.w;
    r8.w = r8.w + -r7.w;
    r7.w = r1.x * r8.w + r7.w;
    r5.w = r7.w * r5.w;
    r7.w = saturate(dot(r0.xyz, r10.xyz));
    r5.w = r7.w * r5.w;
    r11.xyz = cb1[r3.w+256].xyz * r5.www;
    r9.xyz = r9.xyz * r6.www + r3.xyz;
    ...
    r5.w = r5.w * r5.w;
    r3.w = r3.w * r3.w;
    r5.w = max(0.100000001, r5.w);
    r3.w = r5.w * r3.w;
    r3.w = 3 * r3.w;
    r3.w = 0.0625 / r3.w;
    r9.xyz = r3.www * float3(0.0399999991,0.0399999991,0.0399999991) + r2.xyz;
    r8.xyz = r9.xyz * r11.xyz + r8.xyz;
    r2.w = (int)r2.w + 1;
  }
