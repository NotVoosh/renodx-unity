...
// ---- Created with 3Dmigoto v1.4.1 on Thu Aug  6 23:24:30 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xyzw = t1.SampleBias(s0_s, r1.zw, cb0[5].x).xyzw;
  r3.xyz = r3.xyz * r3.xyz;
  if (cb0[135].x > 0) {
    r4.xyz = r3.xyz * r3.www;
    r3.xyz = float3(8,8,8) * r4.xyz;
  }
  r3.xyz = cb0[134].xxx * r3.xyz * injectedData.fxBloom;
  r0.xyz = r3.xyz * cb0[134].yzw + r0.xyz;
  if (cb0[142].z > 0) {
