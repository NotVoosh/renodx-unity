  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = min(float3(0.999000013,0.999000013,0.999000013), r1.xyz);*/
  r0.xyz = fastSrgbEncodeSafe(r1.xyz);
  r2.xyz = handleUserLUT(r1.xyz, t2, s1_s, float3(1 / 1024, 1 / 32, 31), 1);
  r1.xyzw = t1.Sample(s2_s, v2.zw).xyzw;
  /*r1.yzw = r0.xyz * float3(0.0302734375,0.96875,31) + float3(0.00048828125,0.015625,0.5);
  r1.w = floor(r1.w);
  r1.yz = r1.ww * float2(0.03125,0) + r1.yz;
  r2.xyzw = t2.SampleLevel(s1_s, r1.yz, 0).xyzw;*/
