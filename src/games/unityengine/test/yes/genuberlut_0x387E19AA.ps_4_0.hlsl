  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = cb0[35].www * r0.xyz + r2.xyz;
  ...
  r4.xyz = cb0[31].xyz * r1.xyz;
  r5.xyz = -cb0[31].xyz * float3(2,2,2) + float3(1,1,1);
  r4.xyz = r3.xyz * r5.xyz + r4.xyz;
  if(injectedData.toneMapType == 0.f){
    r4.xyz = saturate(r4.xyz);
  }
  r4.xyz = lerp(r0.xyz, r4.xyz, cb0[31].w);
  r2.xyz = lerp(r4.xyz, r2.xyz, cb0[33].x);
  r4.xyz = cb0[29].xyz * r1.xyz;
  r1.xyz = cb0[28].xyz * r1.xyz;
  r5.xyz = -cb0[29].xyz * float3(2,2,2) + float3(1,1,1);
  r4.xyz = r3.xyz * r5.xyz + r4.xyz;
  if(injectedData.toneMapType == 0.f){
    r4.xyz = saturate(r4.xyz);
  }
  r4.xyz = lerp(r0.xyz, r4.xyz, cb0[29].w);
  r5.xyz = -cb0[28].xyz * float3(2,2,2) + float3(1,1,1);
  r1.xyz = r3.xyz * r5.xyz + r1.xyz;
  if(injectedData.toneMapType == 0.f){
    r1.xyz = saturate(r1.xyz);
  }
  r0.xyz = lerp(r0.xyz, r1.xyz, cb0[28].w);
  r0.xyz = lerp(r0.xyz, r4.xyz, cb0[30].x);
  r0.xyz = lerp(r0.xyz, r2.xyz, cb0[33].y);
