  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyzw = cb0[137].zwzw * float4(0,1,1,0) + v1.xyxy;
  ...
  r2.xyzw = cb0[137].zwzw * float4(0,-1,-1,0) + v1.xyxy;
  ...
  if (r2.x >= r2.y) {
    ...
    r1.y = isHorizontal ? cb0[137].w : cb0[137].z;
    ...
    r2.x = isHorizontal ? cb0[137].z : 0;
    r2.w = isHorizontal ? 0 : cb0[137].w;
