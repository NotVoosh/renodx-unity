  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = cb0[138].x * v1.x;
  r0.x = floor(r0.x);
  r1.x = v1.x * cb0[138].x + -r0.x;
  r0.x = cb0[138].z * r0.x;
  r0.z = cb0[138].w * r0.x;
  r1.y = v1.y;
  r0.xy = -cb0[138].zz + r1.xy;
  r1.x = cb0[138].w;
  r1.z = 2;
  r0.xyz = r1.xxz * r0.xyz;
  r0.xyz = lutShaper(r0.xyz, true, 1);
  float3 preCG = r0.xyz;
  ...
  r0.xyz = r0.xyz * cb0[148].xyz + cb0[150].xyz;
  r1.xyz = log2(abs(r0.xyz));
  r1.xyz = cb0[149].xyz * r1.xyz;
  r1.xyz = exp2(r1.xyz);
  r0.xyz = (r0.xyz > (0.0).xxx) ? r1.xyz : r0.xyz;
  r0.xyz = float3(-0.4135884,-0.4135884,-0.4135884) + r0.xyz;
  r0.xyz = r0.xyz * cb0[144].zzz + float3(0.4135884,0.4135884,0.4135884);
  ...
  r0.w = saturate(cb0[155].w + r0.w);
  r1.w = 1 + -r0.w;
  r3.xyz = float3(-0.5,-0.5,-0.5) + cb0[155].xyz;
  ...
  r2.xyz = r0.xyz * r0.xyz;
  r0.xyz = sqrt(r0.xyz);
  r3.xyz = float3(-0.5,-0.5,-0.5) + cb0[156].xyz;
  ...
  r1.x = dot(r0.xyz, cb0[141].xyz);
  r1.y = dot(r0.xyz, cb0[142].xyz);
  r1.z = dot(r0.xyz, cb0[143].xyz);
  r0.xyz = cb0[152].xyz * r1.xyz;
  r0.w = dot(r1.xyz, float3(0.212672904,0.715152204,0.0721750036));
  r2.xy = -cb0[154].xz + r0.ww;
  r2.zw = cb0[154].yw + -cb0[154].xz;
  ...
  r2.yzw = cb0[151].xyz * r1.xyz;
  r1.xyz = cb0[153].xyz * r1.xyz;
  r0.xyz = r2.yzw * r0.www + r0.xyz;
  r0.xyz = r1.xyz * r2.xxx + r0.xyz;
  float3 preLGG = r0.xyz;
  r0.xyz = r0.xyz * cb0[147].xyz + cb0[145].xyz;
  r2.xyz = sign(r0.xyz) * pow(abs(r0.xyz), cb0[146].xyz);
  r2.xyz = liftGammaGainScaling(r2.xyz, preLGG, cb0[145].xyz, cb0[146].xyz, cb0[147].xyz, 0);
  ...
  r2.z = cb0[144].x + r3.x;
  r2.yw = float2(0,0);
  r4.xyzw = t4.SampleBias(s0_s, r2.zw, cb0[29].x).xyzw;
  r5.xyzw = t7.SampleBias(s0_s, r2.xy, cb0[29].x).xyzw;
  r5.x = saturate(r5.x);
  r0.y = r5.x + r5.x;
  r4.x = saturate(r4.x);
  r0.z = -0.5 + r4.x;
  ...
  r3.yw = float2(0,0);
  r2.xyzw = t5.SampleBias(s0_s, r3.xy, cb0[29].x).xyzw;
  r3.xyzw = t6.SampleBias(s0_s, r3.zw, cb0[29].x).xyzw;
  r3.x = saturate(r3.x);
  r0.x = r3.x + r3.x;
  r2.x = saturate(r2.x);
  r0.w = r2.x + r2.x;
  ...
  r0.w = 0;
  r1.xyzw = t0.SampleBias(s0_s, r0.xw, cb0[29].x).xyzw;
  r1.x = saturate(r1.x);
  r2.xyzw = t0.SampleBias(s0_s, r0.yw, cb0[29].x).xyzw;
  r0.xyzw = t0.SampleBias(s0_s, r0.zw, cb0[29].x).xyzw;
  r1.z = saturate(r0.x);
  r1.y = saturate(r2.x);
  r0.xyz = float3(0.00390625,0.00390625,0.00390625) + r1.xyz;
  r0.w = 0;
  r1.xyzw = t1.SampleBias(s0_s, r0.xw, cb0[29].x).xyzw;
  o0.x = saturate(r1.x);
  r1.xyzw = t2.SampleBias(s0_s, r0.yw, cb0[29].x).xyzw;
  r0.xyzw = t3.SampleBias(s0_s, r0.zw, cb0[29].x).xyzw;
  o0.z = saturate(r0.x);
  o0.y = saturate(r1.x);
  o0.w = 1;
  if (injectedData.toneMapType != 0.f) {
