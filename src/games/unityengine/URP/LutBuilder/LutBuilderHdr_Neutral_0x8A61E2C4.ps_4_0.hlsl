  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = r0.xyz * cb0[142].zzz + float3(0.4135884,0.4135884,0.4135884);
  ...
  r1.x = saturate(r1.x);
  r2.xyzw = t2.SampleBias(s0_s, r0.yw, cb0[4].x).xyzw;
