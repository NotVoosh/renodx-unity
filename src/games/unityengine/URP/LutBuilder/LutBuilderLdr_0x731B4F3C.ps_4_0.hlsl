  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yz = -cb0[127].yz + v1.xy;
  r1.x = cb0[127].x * r0.y;
  r0.x = frac(r1.x);
  r1.x = r0.x / cb0[127].x;
  r0.w = -r1.x + r0.y;
  r0.xyz = cb0[127].www * r0.xzw;
  ...
  r0.xyz = r0.xyz * cb0[133].zzz + float3(0.4135884,0.4135884,0.4135884);
  r0.xyz = renodx::color::arri::logc::c1000::Decode(r0.xyz, true);
  r0.xyz = cb0[129].xyz * r0.xyz;
  ...
  r1.x = dot(r0.xyz, cb0[130].xyz);
  r1.y = dot(r0.xyz, cb0[131].xyz);
  r1.z = dot(r0.xyz, cb0[132].xyz);
  r0.xyz = cb0[138].xyz * r1.xyz;
  r0.w = dot(r1.xyz, float3(0.212672904,0.715152204,0.0721750036));
  r2.xy = -cb0[140].xz + r0.ww;
  r2.zw = cb0[140].yw + -cb0[140].xz;
  ...
  r2.yzw = cb0[137].xyz * r1.xyz;
  r1.xyz = cb0[139].xyz * r1.xyz;
  r0.xyz = r2.yzw * r0.www + r0.xyz;
  r0.xyz = r1.xyz * r2.xxx + r0.xyz;
  float3 preLGG = r0.xyz;
  r0.xyz = r0.xyz * cb0[136].xyz + cb0[134].xyz;
  r2.xyz = sign(r0.xyz) * pow(abs(r0.xyz), cb0[135].xyz);
  r2.xyz = liftGammaGainScaling(r2.xyz, preLGG, cb0[134].xyz, cb0[135].xyz, cb0[136].xyz);
