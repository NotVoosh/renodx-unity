  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.rgb = mul(ACES_to_ACEScg_MAT, r1.xyz);
  ...
  r2.xyz = liftGammaGainScaling(r2.xyz, preLGG, cb0[135].xyz, cb0[136].xyz, cb0[137].xyz, 1);
  r3.xy = r2.zy;
  r0.xy = r2.yz + -r3.xy;
  r1.x = step(r2.z, r3.y);
  ...
  r0.w = (r0.y > 1.0) ? r0.w : r0.y;
  r0.y = (r0.y < 0.0) ? r0.z : r0.w;
