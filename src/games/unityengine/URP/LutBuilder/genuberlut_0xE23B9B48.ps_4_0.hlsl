  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = cb0[29].xyz * r0.xyz;
  r1.xyz = r1.xyz + r1.xyz;
  r2.xyz = float3(1,1,1) + -r0.xyz;
  r2.xyz = r2.xyz + r2.xyz;
  if(injectedData.toneMapType == 0.f){
  r3.xyz = float3(1,1,1) + -cb0[29].xyz;
  r3.xyz = -r2.xyz * r3.xyz + float3(1,1,1);
  r1.xyz = float3(0.5,0.5,0.5) >= r0.xyz ? r1.xyz : r3.xyz;
  r1.xyz = saturate(r1.xyz);
  } else {
    r3.xyz = r0.xyz + (cb0[29].xyz + (1 / r0.xyz));
    r1.xyz = float3(0.5,0.5,0.5) >= r0.xyz ? r1.xyz : r3.xyz;
  }
  r1.xyz = lerp(r0.xyz, r1.xyz, cb0[29].w);
  r3.xyz = cb0[28].xyz * r0.xyz;
  r3.xyz = r3.xyz + r3.xyz;
  if(injectedData.toneMapType == 0.f){
  r5.xyz = float3(1,1,1) + -cb0[28].xyz;
  r2.xyz = -r2.xyz * r5.xyz + float3(1,1,1);
  r2.xyz = float3(0.5,0.5,0.5) >= r0.xyz ? r3.xyz : r2.xyz;
  r2.xyz = saturate(r2.xyz);
  } else {
    r2.xyz = r0.xyz + (cb0[28].xyz + (1 / r0.xyz));
    r2.xyz = float3(0.5,0.5,0.5) >= r0.xyz ? r3.xyz : r2.xyz;
  }
  r0.xyz = lerp(r0.xyz, r2.xyz, cb0[28].w);
  r0.xyz = lerp(r0.xyz, r1.xyz, cb0[30].x);
