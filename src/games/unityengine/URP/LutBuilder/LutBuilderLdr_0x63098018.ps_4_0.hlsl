  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = cb0[142].x * v1.x;
  r0.x = floor(r0.x);
  r1.x = v1.x * cb0[142].x + -r0.x;
  r0.x = cb0[142].z * r0.x;
  r0.z = cb0[142].w * r0.x;
  r1.y = v1.y;
  r0.xy = -cb0[142].zz + r1.xy;
  r1.x = cb0[142].w;
  r1.z = 2;
  ...
  r2.xyz = r0.xyz * r0.xyz;
  r0.xyz = sqrt(r0.xyz);
  r3.xyz = float3(-0.5,-0.5,-0.5) + cb0[157].xyz;
  ...
  r1.x = dot(r0.xyz, cb0[145].xyz);
  r1.y = dot(r0.xyz, cb0[146].xyz);
  r1.z = dot(r0.xyz, cb0[147].xyz);
  r0.xyz = cb0[153].xyz * r1.xyz;
  r0.w = dot(r1.xyz, float3(0.212672904,0.715152204,0.0721750036));
  r2.xy = -cb0[155].xz + r0.ww;
  r2.zw = cb0[155].yw + -cb0[155].xz;
  ...
  r2.yzw = cb0[152].xyz * r1.xyz;
  r1.xyz = cb0[154].xyz * r1.xyz;
  r0.xyz = r2.yzw * r0.www + r0.xyz;
  r0.xyz = r1.xyz * r2.xxx + r0.xyz;
  float3 preLGG = r0.xyz;
  r0.xyz = r0.xyz * cb0[151].xyz + cb0[149].xyz;
  r2.xyz = sign(r0.xyz) * pow(abs(r0.xyz), cb0[150].xyz);
  r2.xyz = liftGammaGainScaling(r2.xyz, preLGG, cb0[149].xyz, cb0[150].xyz, cb0[151].xyz);
