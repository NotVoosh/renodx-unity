  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyz = sign(r0.xyz) * pow(abs(r0.xyz), cb0[133].xyz);
  r2.xyz = liftGammaGainScaling(r2.xyz, preLGG, cb0[132].xyz, cb0[133].xyz, cb0[134].xyz);
