  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yz = -cb0[1402].yz + v1.xy;
  r1.x = cb0[1402].x * r0.y;
  r0.x = frac(r1.x);
  r1.x = r0.x / cb0[1402].x;
  r0.w = -r1.x + r0.y;
  r0.xyz = cb0[1402].www * r0.xzw;
  ...
  r0.xyz = r0.xyz * cb0[1408].zzz + float3(0.4135884,0.4135884,0.4135884);
  r0.xyz = renodx::color::arri::logc::c1000::Decode(r0.xyz, true);
  r0.xyz = cb0[1404].xyz * r0.xyz;
  ...
  r0.w = saturate(cb0[1416].w + r0.w);
  r1.w = 1 + -r0.w;
  r3.xyz = float3(-0.5,-0.5,-0.5) + cb0[1416].xyz;
  ...
  r2.xyz = r0.xyz * r0.xyz;
  r0.xyz = sqrt(r0.xyz);
  r3.xyz = float3(-0.5,-0.5,-0.5) + cb0[1417].xyz;
  ...
  r1.x = dot(r0.xyz, cb0[1405].xyz);
  r1.y = dot(r0.xyz, cb0[1406].xyz);
  r1.z = dot(r0.xyz, cb0[1407].xyz);
  r0.xyz = cb0[1413].xyz * r1.xyz;
  r0.w = dot(r1.xyz, float3(0.212672904,0.715152204,0.0721750036));
  r2.xy = -cb0[1415].xz + r0.ww;
  r2.zw = cb0[1415].yw + -cb0[1415].xz;
  ...
  r2.yzw = cb0[1412].xyz * r1.xyz;
  r1.xyz = cb0[1414].xyz * r1.xyz;
  r0.xyz = r2.yzw * r0.www + r0.xyz;
  r0.xyz = r1.xyz * r2.xxx + r0.xyz;
  float3 preLGG = r0.xyz;
  r0.xyz = r0.xyz * cb0[1411].xyz + cb0[1409].xyz;
  r2.xyz = sign(r0.xyz) * pow(abs(r0.xyz), cb0[1410].xyz);
  r2.xyz = liftGammaGainScaling(r2.xyz, preLGG, cb0[1409].xyz, cb0[1410].xyz, cb0[1411].xyz);
  ...
  o0.rgb = lerp(preCG, o0.rgb, injectedData.colorGradeInternalLUTStrength);
  if (injectedData.tonemapCheck == 1.f && (injectedData.count2Old == injectedData.count2New)) {
    o0.rgb = applyUserNoTonemap(o0.rgb);
  }
  return;
}