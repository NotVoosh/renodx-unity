  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = cb0[128].yyy * r1.xyz * CUSTOM_BLOOM;
  ...
  r0.xyz = cb0[144].xxx * r1.xyz + r0.xyz;
  ...
  if (cb0[139].z > 0) {
    ...
    r1.yz = cb0[139].zz * abs(r1.xy) * min(1.f, CUSTOM_VIGNETTE);
    r1.x = cb0[138].w * r1.y;
    r0.w = dot(r1.xz, r1.xz);
    r0.w = 1 + -r0.w;
    r0.w = max(0, r0.w);
    r0.w = log2(r0.w);
    r0.w = cb0[139].w * r0.w * max(1.f, CUSTOM_VIGNETTE);
    r0.w = exp2(r0.w);
  ...
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
    ...
    r0.xyz = renodx::lut::SampleTetrahedral(t2, r0.yzx, cb0[129].z + 1u);
  }
  if (cb0[130].w > 0) {
    r1.xyz = fastSrgbEncodeSafe(r0.xyz);
    r2.xyz = handleUserLUT(r0.xyz, t3, s0_s, cb0[130].xyz, 1);
