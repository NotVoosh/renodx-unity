  ...
  out float4 o0 : SV_Target0)
{
  ...
  if(injectedData.tonemapCheck > 1.f || injectedData.count2Old < injectedData.count2New){
    float newPeak = renodx::lut::Sample(t1, s0_s, lutShaper((injectedData.toneMapPeakNits / injectedData.toneMapGameNits).xxx, false, 1), cb0[136].z + 1u).x * injectedData.toneMapGameNits;
