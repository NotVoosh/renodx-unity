  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyzw = cb0[147].xyxy * float4(-0.5,-0.5,0.5,-0.5) + v1.xyxy;
  r2.xyzw = t4.SampleBias(s0_s, r1.xy, cb0[5].x).xyzw;
  r1.xyzw = t4.SampleBias(s0_s, r1.zw, cb0[5].x).xyzw;
  r1.xyz = r2.xyz + r1.xyz;
  r2.xyzw = cb0[147].xyxy * float4(-0.5,0.5,0.5,0.5) + v1.xyxy;
  r3.xyzw = t4.SampleBias(s0_s, r2.xy, cb0[5].x).xyzw;
  r1.xyz = r3.xyz + r1.xyz;
  r2.xyzw = t4.SampleBias(s0_s, r2.zw, cb0[5].x).xyzw;
  r1.xyz = r2.xyz + r1.xyz;
  ...
  r0.w = cb0[151].y + -r0.w;
  r1.x = 0.01 + cb0[151].y;
  r0.w = saturate(r0.w / r1.x) * CUSTOM_LENS;
  ...
  if (cb0[142].z > 0) {
    ...
    r0.w = max(0, r0.w);
    r0.w = log2(r0.w);
    r0.w = cb0[142].w * r0.w * min(1.f, CUSTOM_VIGNETTE);
    r0.w = exp2(r0.w);
