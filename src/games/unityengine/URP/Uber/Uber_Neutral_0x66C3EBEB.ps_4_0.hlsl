  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.yzw = cb0[119].xxx * r3.xyz * CUSTOM_BLOOM;
  r0.x = r2.x;
  r0.y = r4.y;
  ...
  if (cb0[118].w > 0) {
    ...
    r2.xyz = cb0[118].zzz * r1.zxy;
    r0.w = floor(r2.x);
    r2.xw = float2(0.5,0.5) * cb0[118].xy;
    r2.yz = r2.yz * cb0[118].xy + r2.xw;
    r2.x = r0.w * cb0[118].y + r2.y;
    r3.xyzw = t3.SampleLevel(s0_s, r2.xz, 0).xyzw;
    r4.x = cb0[118].y;
    r4.y = 0;
    r2.xy = r4.xy + r2.xz;
    r2.xyzw = t3.SampleLevel(s0_s, r2.xy, 0).xyzw;
    r0.w = r1.z * cb0[118].z + -r0.w;
