  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyzw = cb0[143].xxxx * r2.xyzw * CUSTOM_CHROMATIC_ABERRATION;
  ...
  r1.yzw = cb0[138].xxx * r3.xyz * CUSTOM_BLOOM;
  r0.x = r1.x;
  r0.y = r2.y;
  ...
  if (cb0[137].w > 0) {
    ...
    r2.xyz = handleUserLUT(r1.xyz, t4, s0_s, cb0[137].xyz, 0);
  ...
  r0.xyz = r0.xxx * r0.yzw + r3.xyz;
    ...
    r0.xyz = renodx::lut::SampleTetrahedral(t3, r1.xyz, cb0[136].z + 1u);
  }
