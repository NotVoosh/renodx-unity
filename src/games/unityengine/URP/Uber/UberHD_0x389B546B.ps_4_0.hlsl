  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyzw = float4(-1,-1,1,1) * cb0[141].xyxy;
  r0.w = 0.5 * cb0[143].x;
  r2.xyzw = r1.xyzy * r0.wwww + v1.xyxy;
  r3.xyzw = t3.SampleBias(s0_s, r2.xy, cb0[19].x).xyzw;
  r2.xyzw = t3.SampleBias(s0_s, r2.zw, cb0[19].x).xyzw;
  r2.xyz = r3.xyz + r2.xyz;
  r1.xyzw = r1.xwzw * r0.wwww + v1.xyxy;
  r3.xyzw = t3.SampleBias(s0_s, r1.xy, cb0[19].x).xyzw;
  r2.xyz = r3.xyz + r2.xyz;
  r1.xyzw = t3.SampleBias(s0_s, r1.zw, cb0[19].x).xyzw;
  r1.xyz = r2.xyz + r1.xyz;
  r1.xyz = cb0[143].yyy * r1.xyz * CUSTOM_BLOOM;
  r2.xy = v1.xy * cb0[142].xy + cb0[142].zw;
  r2.xyzw = t4.SampleBias(s0_s, r2.xy, cb0[19].x).xyzw;
  r1.xyz = float3(0.25,0.25,0.25) * r1.xyz;
  r2.xyz = cb0[143].zzz * r2.xyz * CUSTOM_LENS;
