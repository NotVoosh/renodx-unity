  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = cb0[140].xxxx * r0.xyzw * CUSTOM_CHROMATIC_ABERRATION;
  ...
  r1.y = renodx::color::srgb::DecodeSafe(r2.y);
  r1.z = renodx::color::srgb::DecodeSafe(r0.z);
  r0.xy = v1.xy * cb0[145].zw + float2(0.5,0.5);
  r0.zw = floor(r0.xy);
  r0.xy = frac(r0.xy);
  r2.xyzw = -r0.xyxy * float4(0.5,0.5,0.166666672,0.166666672) + float4(0.5,0.5,0.5,0.5);
  r2.xyzw = r0.xyxy * r2.xyzw + float4(0.5,0.5,-0.5,-0.5);
  r3.xy = r0.xy * float2(0.5,0.5) + float2(-1,-1);
  r3.zw = r0.xy * r0.xy;
  r3.xy = r3.zw * r3.xy + float2(0.666666687,0.666666687);
  r2.xyzw = r0.xyxy * r2.xyzw + float4(0.166666672,0.166666672,0.166666672,0.166666672);
  ...
  r3.xy = r0.xy * r4.xy + float2(1,1);
  r4.xyzw = r3.zwxw + r0.zwzw;
  ...
  r0.xyzw = r3.zyxy + r0.zwzw;
  r0.xyzw = float4(-0.5,-0.5,-0.5,-0.5) + r0.xyzw;
  r0.xyzw = cb0[145].xyxy * r0.xyzw;
  r0.xyzw = min(float4(1,1,1,1), r0.xyzw);
  r3.xyzw = t1.SampleLevel(s0_s, r0.xy, 0).xyzw;
  r0.xyzw = t1.SampleLevel(s0_s, r0.zw, 0).xyzw;
  r0.xyzw = r2.xxxx * r0.xyzw;
  r0.xyzw = r2.zzzz * r3.xyzw + r0.xyzw;
  r0.xyzw = r2.yyyy * r0.xyzw;
  r0.xyzw = r2.wwww * r4.xyzw + r0.xyzw;
  r0.xyz = r0.xyz * r0.xyz;
  if (cb0[135].x > 0) {
    r2.xyz = r0.xyz * r0.www;
    r0.xyz = float3(8,8,8) * r2.xyz;
  }
  r0.xyz = cb0[134].xxx * r0.xyz * CUSTOM_BLOOM;
  r0.xyz = r0.xyz * cb0[134].yzw + r1.xyz;
  if (cb0[142].z > 0) {
