  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = v1.xy * cb0[1415].zw + float2(0.5,0.5);
  r1.zw = floor(r1.xy);
  r1.xy = frac(r1.xy);
  ...
  r1.xyz = cb0[1404].xxx * r1.xyz * injectedData.fxBloom;
  r0.xyz = r1.xyz * cb0[1404].yzw + r0.xyz;
  if (cb0[1412].z > 0) {
  ...
  if (cb0[1403].w > 0) {
    ...
    r2.xyz = handleUserLUT(r0.xyz, t3, s0_s, cb0[1403].xyz);
  ...
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
    ...
    r0.xyz = renodx::lut::SampleTetrahedral(t2, r0.xyz, cb0[1402].z + 1u);
  }
