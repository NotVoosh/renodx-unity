  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = v1.xy * cb0[138].zw + float2(0.5,0.5);
  r1.zw = floor(r1.xy);
  r1.xy = frac(r1.xy);
  ...
  if(injectedData.tonemapCheck > 1.f || injectedData.count2Old < injectedData.count2New){
    float newPeak = renodx::lut::Sample(t2, s0_s, lutShaper((injectedData.toneMapPeakNits / injectedData.toneMapGameNits).xxx, false, 1), cb0[125].z + 1u).x * injectedData.toneMapGameNits;
