  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = r1.xy * cb0[149].zw + float2(0.5,0.5);
  r1.zw = floor(r1.xy);
  r1.xy = frac(r1.xy);
  ...
  r1.xyz = cb0[139].xxx * r1.xyz * CUSTOM_BLOOM;
  ...
  r1.xyzw = t2.SampleBias(s2_s, r1.xy, cb0[4].x).xyzw;
  r0.w = -0.5 + r1.w;
  r0.w = r0.w + r0.w;
  ...
  r1.xyzw = t5.SampleBias(s1_s, r1.xy, cb0[4].x).xyzw;
  r0.w = r1.w * 2 + -1;
  r1.x = r0.w >= 0 ? 1 : -1;
  r0.w = 1 + -abs(r0.w);
  r0.w = sqrt(r0.w);
