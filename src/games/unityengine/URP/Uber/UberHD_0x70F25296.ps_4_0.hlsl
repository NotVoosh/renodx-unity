  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = cb0[133].xxxx * r0.xyzw * CUSTOM_CHROMATIC_ABERRATION;
  r1.xyzw = t0.Sample(s0_s, v1.xy).xyzw;
  r0.xyzw = r0.xyzw * float4(-0.333333343,-0.333333343,-0.666666687,-0.666666687) + v1.xyxy;
  r2.xyzw = t0.Sample(s0_s, r0.xy).xyzw;
  r0.xyzw = t0.Sample(s0_s, r0.zw).xyzw;
  if (cb0[135].z > 0) {
    r1.yz = -cb0[135].xy + v1.xy;
    r3.yz = cb0[135].zz * abs(r1.yz) * min(1.f, CUSTOM_VIGNETTE);
    r3.x = cb0[134].w * r3.y;
    ...
    r0.w = exp2(r0.w);
    r1.yzw = float3(1,1,1) + -cb0[134].xyz;
    r1.yzw = r0.www * r1.yzw + cb0[134].xyz;
    r0.x = r1.x;
    r0.y = r2.y;
  ...
  if (cb0[126].w > 0) {
    ...
    r2.xyz = handleUserLUT(r0.xyz, t3, s0_s, cb0[126].z + 1u);
  ...
  r1.yzw = cb0[136].xxx * r1.yzw * CUSTOM_FILM_GRAIN;
