  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = cb0[141].xxxx * r0.xyzw * injectedData.fxCA;
  ...
  r2.yzw = cb0[135].xxx * r3.xyz * injectedData.fxBloom;
  r0.x = r2.x;
  r0.y = r4.y;
  r0.xyz = r2.yzw * cb0[135].yzw + r0.xyz;
  if (cb0[143].z > 0) {
    r1.xy = -cb0[143].xy + r1.zw;
    r1.xy = cb0[132].xy * abs(r1.xy) * min(1.f, injectedData.fxVignette);
