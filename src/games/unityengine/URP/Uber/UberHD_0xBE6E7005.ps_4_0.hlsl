  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.zw = r0.xy * cb0[140].zz + float2(0.5,0.5);
  r0.xy = r0.xy * cb0[140].zz + -cb0[139].xy;
  r0.xy = cb0[139].zw * r0.xy;
  r1.x = dot(r0.xy, r0.xy);
  r1.x = sqrt(r1.x);
  if (cb0[140].w > 0) {
    r1.zw = cb0[140].xy * r1.xx;
  ...
  r0.xyzw = cb0[141].xxxx * r0.xyzw * CUSTOM_CHROMATIC_ABERRATION;
  ...
  r3.xyzw = r0.xyzw * cb0[140].zzzz + float4(0.5,0.5,0.5,0.5);
  r0.xyzw = r0.xyzw * cb0[140].zzzz + -cb0[139].xyxy;
  r0.xyzw = cb0[139].zwzw * r0.xyzw;
  r1.x = dot(r0.xy, r0.xy);
  r1.x = sqrt(r1.x);
  if (cb0[140].w > 0) {
    r2.yz = cb0[140].xy * r1.xx;
  ...
  r1.xy = r1.zw * cb0[146].zw + float2(0.5,0.5);
  r2.yz = floor(r1.xy);
  r1.xy = frac(r1.xy);
  ...
  r2.yzw = cb0[135].xxx * r3.xyz * CUSTOM_BLOOM;
  r0.x = r2.x;
  r0.y = r4.y;
  r0.xyz = r2.yzw * cb0[135].yzw + r0.xyz;
  if (cb0[143].z > 0) {
    r1.xy = -cb0[143].xy + r1.zw;
    r1.xy = cb0[132].xy * abs(r1.xy) * min(1.f, CUSTOM_VIGNETTE);
    r0.w = dot(r1.xy, r1.xy);
    r0.w = 1 + -r0.w;
    r0.w = max(0, r0.w);
    r0.w = log2(r0.w);
    r0.w = cb0[143].w * r0.w * max(1.f, CUSTOM_VIGNETTE);
    r0.w = exp2(r0.w);
    r1.xyz = float3(1,1,1) + -cb0[142].xyz;
    r1.xyz = r0.www * r1.xyz + cb0[142].xyz;
    r0.xyz = r1.xyz * r0.xyz;
  }
  r0.xyz = cb0[133].www * r0.zxy;
  r0.yzx = lutShaper(r0.yzx);
  if(CUSTOM_LUT_SAMPLE == 0.f){
  r0.yzw = cb0[133].zzz * r0.xyz;
  r0.y = floor(r0.y);
  r1.xy = float2(0.5,0.5) * cb0[133].xy;
  r1.yz = r0.zw * cb0[133].xy + r1.xy;
  r1.x = r0.y * cb0[133].y + r1.y;
  r2.xyzw = t2.SampleLevel(s0_s, r1.xz, 0).xyzw;
  r3.x = cb0[133].y;
  r3.y = 0;
  r0.zw = r3.xy + r1.xz;
  r1.xyzw = t2.SampleLevel(s0_s, r0.zw, 0).xyzw;
  r0.x = r0.x * cb0[133].z + -r0.y;
  r0.yzw = r1.xyz + -r2.xyz;
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
  } else {
    r0.xyz = renodx::lut::SampleTetrahedral(t2, r0.yzx, cb0[133].z + 1u);
  }
  if (cb0[134].w > 0) {
    r1.xyz = fastSrgbEncodeSafe(r0.xyz);
    r2.xyz = handleUserLUT(r0.xyz, t3, s0_s, cb0[134].xyz, 1);
    r2.xyz = r2.xyz + -r1.xyz;
    r1.xyz = cb0[134].www * r2.xyz + r1.xyz;
