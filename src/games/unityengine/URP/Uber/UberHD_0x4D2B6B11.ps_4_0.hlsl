  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = cb0[119].xxx * r1.xyz * CUSTOM_BLOOM;
  ...
  r0.xyz = cb0[117].www * r0.zxy;
  r0.yzx = lutShaper(r0.yzx);
  if(CUSTOM_LUT_SAMPLE == 0.f){
  r0.yzw = cb0[117].zzz * r0.xyz;
  r0.y = floor(r0.y);
  r1.xy = float2(0.5,0.5) * cb0[117].xy;
  r1.yz = r0.zw * cb0[117].xy + r1.xy;
  r1.x = r0.y * cb0[117].y + r1.y;
  r2.xyzw = t2.SampleLevel(s0_s, r1.xz, 0).xyzw;
  r3.x = cb0[117].y;
  r3.y = 0;
  r0.zw = r3.xy + r1.xz;
  r1.xyzw = t2.SampleLevel(s0_s, r0.zw, 0).xyzw;
  r0.x = r0.x * cb0[117].z + -r0.y;
  r0.yzw = r1.xyz + -r2.xyz;
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
  } else {
    r0.xyz = renodx::lut::SampleTetrahedral(t2, r0.yzx, cb0[117].z + 1u);
  }
  if (cb0[118].w > 0) {
