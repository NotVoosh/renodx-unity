  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = cb0[125].xxxx * r0.xyzw * CUSTOM_CHROMATIC_ABERRATION;
  r1.xyzw = t0.Sample(s0_s, v1.xy).xyzw;
  r0.xyzw = r0.xyzw * float4(-0.333333343,-0.333333343,-0.666666687,-0.666666687) + v1.xyxy;
  r2.xyzw = t0.Sample(s0_s, r0.xy).xyzw;
  r0.xyzw = t0.Sample(s0_s, r0.zw).xyzw;
  if (cb0[127].z > 0) {
    r1.yz = -cb0[127].xy + v1.xy;
    r3.yz = cb0[127].zz * abs(r1.yz) * min(1.f, CUSTOM_VIGNETTE);
    r3.x = cb0[126].w * r3.y;
    r0.w = dot(r3.xz, r3.xz);
    r0.w = 1 + -r0.w;
    r0.w = max(0, r0.w);
    r0.w = log2(r0.w);
    r0.w = cb0[127].w * r0.w * max(1.f, CUSTOM_VIGNETTE);
    r0.w = exp2(r0.w);
    r1.yzw = float3(1,1,1) + -cb0[126].xyz;
    r1.yzw = r0.www * r1.yzw + cb0[126].xyz;
    r0.x = r1.x;
    r0.y = r2.y;
  ...
  if (cb0[118].w > 0) {
    ...
    r2.xyz = handleUserLUT(r0.xyz, t3, s0_s, cb0[118].xyz);
  ...
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
    ...
    r0.xyz = renodx::lut::SampleTetrahedral(t2, r0.xyz, cb0[117].z + 1u);
  }
  ...
  r1.yzw = cb0[128].xxx * r1.yzw * CUSTOM_FILM_GRAIN;
  r0.xyz = r1.yzw * r1.xxx + r0.xyz;
  } else {
    r0.xyz = applyFilmGrain(r0.xyz, v1);
  }
  r1.xy = v1.xy * cb0[131].xy + cb0[131].zw;
