  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = cb0[134].xxxx * r0.xyzw * CUSTOM_BLOOM;
  ...
  r1.xyz = cb0[128].xxx * r1.xyz * CUSTOM_BLOOM;
  r0.xyz = r1.xyz * cb0[128].yzw + r0.xyz;
  r2.xy = v1.xy * cb0[130].xy + cb0[130].zw;
  r2.xyzw = t2.Sample(s0_s, r2.xy).xyzw;
  r2.xyz = cb0[131].xxx * r2.xyz * CUSTOM_LENS;
  r0.xyz = r2.xyz * r1.xyz + r0.xyz;
  if (cb0[136].z > 0) {
    r1.xy = -cb0[136].xy + v1.xy;
    r1.yz = cb0[136].zz * abs(r1.xy) * min(1.f, CUSTOM_VIGNETTE);
    r1.x = cb0[135].w * r1.y;
    r0.w = dot(r1.xz, r1.xz);
    r0.w = 1 + -r0.w;
    r0.w = max(0, r0.w);
    r0.w = log2(r0.w);
    r0.w = cb0[136].w * r0.w * max(1.f, CUSTOM_VIGNETTE);
    r0.w = exp2(r0.w);
  ...
  if (cb0[127].w > 0) {
    ...
    r2.xyz = handleUserLUT(r0.xyz, t5, s0_s, cb0[127].xyz);
  ...
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
    ...
    r0.xyz = renodx::lut::SampleTetrahedral(t4, r0.xyz, cb0[126].z + 1u);
  }
  ...
  r1.yzw = cb0[137].xxx * r1.yzw * CUSTOM_FILM_GRAIN;
