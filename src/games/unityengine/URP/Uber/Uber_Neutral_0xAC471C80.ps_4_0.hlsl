  ...
  out float4 o0 : SV_Target0)
{
  ...
  float3 newPeak = renodx::lut::Sample(t4, s0_s, lutShaper((injectedData.toneMapPeakNits / injectedData.toneMapGameNits), false, 1), cb0[117].z + 1u) * injectedData.toneMapGameNits;
