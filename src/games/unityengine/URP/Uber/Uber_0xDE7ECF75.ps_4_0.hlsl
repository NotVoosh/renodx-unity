  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = cb0[1404].xxxx * r0.xyzw * injectedData.fxCA;
  ...
  if (cb0[1406].z > 0) {
    ...
    r1.yz = cb0[1406].zz * abs(r1.xy) * min(1.f, injectedData.fxVignette);
    r1.x = cb0[1405].w * r1.y;
    r0.w = dot(r1.xz, r1.xz);
    r0.w = 1 + -r0.w;
    r0.w = max(0, r0.w);
    r0.w = log2(r0.w);
    r0.w = cb0[1406].w * r0.w * max(1.f, injectedData.fxVignette);
    r0.w = exp2(r0.w);
  ...
  if (cb0[1397].w > 0) {
    ...
    r2.xyz = handleUserLUT(r0.xyz, t2, s0_s, cb0[1397].xyz);
  ...
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
    ...
    r0.xyz = renodx::lut::SampleTetrahedral(t1, r0.xyz, cb0[1396].z + 1u);
  }
