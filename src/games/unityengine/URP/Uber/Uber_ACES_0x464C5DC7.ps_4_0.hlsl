  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = r0.xxx * r0.yzw + r4.xyz;
    ...
    r0.xyz = renodx::lut::SampleTetrahedral(t1, r2.xyz, cb0[145].z + 1u);
  }
  r1.xyzw = t3.SampleBias(s0_s, r1.zw, cb0[4].x).xyzw;
  r0.w = renodx::color::y::from::BT709(r0.xyz);
  r1.y = 1.04999995 * r0.x;
  r1.y = r1.y / cb0[165].x;
  r1.zw = r0.yz / cb0[165].yz;
  r2.xyz = r1.yyy * cb0[160].www + cb0[162].xyz;
  r3.xyz = r1.zzz * cb0[160].www + cb0[163].xyz;
  r1.yzw = r1.www * cb0[160].www + cb0[164].xyz;
  r2.xyz = r3.xyz * r2.xyz;
  r1.yzw = r2.xyz * r1.yzw;
  r2.x = renodx::color::y::from::BT709(r1.yzw);
  r1.yzw = renodx::color::arri::logc::c1000::Encode(r1.yzw, false);
  ...
  r1.yzw = cb0[160].yyy * r1.yzw + r2.xxx;
  r2.x = 1 + -cb0[160].x;
