  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[118].w > 0) {
    ...
    r2.xyz = handleUserLUT(r0.xyz, t5, s0_s, cb0[118].xyz);
  ...
  r0.y = 0;
  r0.xy = r1.xz + r0.xy;
  r1.xyzw = t4.SampleLevel(s0_s, r0.xy, 0).xyzw;
  r0.x = r0.z * cb0[117].z + -r0.w;
  r0.yzw = r1.xyz + -r2.xyz;
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
  } else {
    r0.xyz = renodx::lut::SampleTetrahedral(t4, r0.xyz, cb0[117].z + 1u);
  }
