  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[140].z > 0) {
    ...
    r1.yz = cb0[140].zz * abs(r1.xy) * min(1.f, CUSTOM_VIGNETTE);
    r1.x = cb0[139].w * r1.y;
    r1.x = dot(r1.xz, r1.xz);
    r1.x = 1 + -r1.x;
    r1.x = max(0, r1.x);
    r1.x = log2(r1.x);
    r1.x = cb0[140].w * r1.x * max(1.f, CUSTOM_VIGNETTE);
    r1.x = exp2(r1.x);
  ...
  r1.xyz = r0.xxx * r1.xyz + r2.xyz;
    ...
    r1.xyz = renodx::lut::SampleTetrahedral(t1, r0.yzx, cb0[130].z + 1u);
  }
  if (cb0[131].w > 0) {
    r0.xyz = renodx::color::srgb::EncodeSafe(r1.xyz);
    r2.xyz = handleUserLUT(r1.xyz, t2, s0_s, cb0[131].xyz);
