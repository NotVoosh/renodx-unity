  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[146].z > 0) {
    r1.xz = -cb0[146].xy + v1.xy;
    r3.yz = cb0[146].zz * abs(r1.xz) * min(1.f, injectedData.fxVignette);
    r3.x = cb0[145].w * r3.y;
    ...
    r0.w = exp2(r0.w);
    r1.xzw = float3(1,1,1) + -cb0[145].xyz;
    r1.xzw = r0.www * r1.xzw + cb0[145].xyz;
    r0.x = r2.x;
    r0.y = r1.y;
  ...
  float3 newPeak = renodx::lut::Sample(t1, s0_s, lutShaper((injectedData.toneMapPeakNits / injectedData.toneMapGameNits), false, 1), cb0[136].z + 1u) * injectedData.toneMapGameNits;
