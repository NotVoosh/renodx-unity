  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = cb0[140].xxx * r1.xyz * CUSTOM_BLOOM;
  r0.xyz = r1.xyz * cb0[140].yzw + r0.xyz;
  if (cb0[148].z > 0) {
    r1.xy = -cb0[148].xy + v1.xy;
    r1.yz = cb0[148].zz * abs(r1.xy) * min(1.f, CUSTOM_VIGNETTE);
    r1.x = cb0[147].w * r1.y;
    r0.w = dot(r1.xz, r1.xz);
    r0.w = 1 + -r0.w;
    r0.w = max(0, r0.w);
    r0.w = log2(r0.w);
    r0.w = cb0[148].w * r0.w * max(1.f, CUSTOM_VIGNETTE);
    r0.w = exp2(r0.w);
  ...
  if (cb0[139].w > 0) {
    ...
    r2.xyz = handleUserLUT(r0.xyz, t3, s0_s, cb0[139].xyz);
    r2.xyz = r2.xyz + -r1.xyz;
    r1.xyz = cb0[139].www * r2.xyz + r1.xyz;
    r0.xyz = renodx::color::srgb::DecodeSafe(r1.xyz);
  }
  r0.xyz = lutShaper(r0.xyz, false, 1);
  if(CUSTOM_LUT_SAMPLE == 0.f){
  r0.xyw = cb0[138].zzz * r0.xyz;
  r0.w = floor(r0.w);
  r1.xy = float2(0.5,0.5) * cb0[138].xy;
  r1.yz = r0.xy * cb0[138].xy + r1.xy;
  r1.x = r0.w * cb0[138].y + r1.y;
  r2.xyzw = t2.SampleLevel(s0_s, r1.xz, 0).xyzw;
  r0.x = cb0[138].y;
  r0.y = 0;
  r0.xy = r1.xz + r0.xy;
  r1.xyzw = t2.SampleLevel(s0_s, r0.xy, 0).xyzw;
  r0.x = r0.z * cb0[138].z + -r0.w;
  r0.yzw = r1.xyz + -r2.xyz;
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
  } else {
    r0.xyz = renodx::lut::SampleTetrahedral(t2, r0.xyz, cb0[138].z + 1u);
  }
  ...
  r1.xyzw = t4.SampleBias(s1_s, r1.xy, cb0[29].x).xyzw;
  r0.w = r1.w * 2 + -1;
  r1.x = r0.w >= 0 ? 1 : -1;
  r0.w = 1 + -abs(r0.w);
  r0.w = sqrt(r0.w);
