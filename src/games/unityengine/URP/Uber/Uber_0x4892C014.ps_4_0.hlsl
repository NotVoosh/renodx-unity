  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = cb0[136].xxxx * r0.xyzw * CUSTOM_CHROMATIC_ABERRATION;
  ...
  r1.yzw = cb0[130].xxx * r3.xyz * CUSTOM_BLOOM;
  r0.x = r1.x;
  r0.y = r2.y;
  ...
  if (cb0[129].w > 0) {
    ...
    r2.xyz = handleUserLUT(r0.xyz, t5, s0_s, cb0[129].xyz);
  ...
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
    ...
    r0.xyz = renodx::lut::SampleTetrahedral(t4, r0.xyz, cb0[128].z + 1u);
  }
  ...
  r1.xyzw = t6.SampleBias(s2_s, r1.xy, cb0[19].x).xyzw;
  r0.w = r1.w * 2 + -1;
  r1.x = (r0.w >= 0) ? 1 : -1;
  r0.w = 1 + -abs(r0.w);
  r0.w = sqrt(r0.w);
