  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[139].w > 0) {
    ...
    r2.xyz = handleUserLUT(r1.xyz, t4, s0_s, cb0[139].xyz);
  ...
  r0.xyz = r0.xxx * r0.yzw + r3.xyz;
    ...
    r0.xyz = renodx::lut::SampleTetrahedral(t3, r1.xyz, cb0[138].z + 1u);
  }
  if(injectedData.toneMapType == 0.f){
    r0.xyz = saturate(r0.xyz);
  }
  float3 newPeak = renodx::lut::Sample(t3, s0_s, lutShaper((injectedData.toneMapPeakNits / injectedData.toneMapGameNits), false, 1), cb0[138].z + 1u) * injectedData.toneMapGameNits;
  ...
  r1.xyzw = t2.SampleBias(s1_s, r1.xy, cb0[29].x).xyzw;
  r0.w = -0.5 + r1.w;
  r0.w = r0.w + r0.w;
  r1.x = renodx::color::y::from::BT709(saturate(r0.xyz));
  r1.x = sqrt(r1.x);
  r1.x = cb0[149].y * -r1.x + 1;
  r1.yzw = r0.xyz * r0.www;
  r1.yzw = cb0[149].xxx * r1.yzw * injectedData.fxFilmGrain;
  r0.xyz = r1.yzw * r1.xxx + r0.xyz;
  } else {
    r0.xyz = applyFilmGrain(r0.xyz, v1);
  }
  r1.xy = v1.xy * cb0[152].xy + cb0[152].zw;
  r1.xyzw = t5.SampleBias(s2_s, r1.xy, cb0[29].x).xyzw;
  r0.w = r1.w * 2 + -1;
  r1.x = r0.w >= 0 ? 1 : -1;
  r0.w = 1 + -abs(r0.w);
  r0.w = sqrt(r0.w);
