  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[139].w > 0) {
    ...
    r2.xyz = handleUserLUT(r0.xyz, t2, s0_s, cb0[139].xyz);
  ...
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
    ...
    r0.xyz = renodx::lut::SampleTetrahedral(t1, r0.xyz, cb0[138].z + 1u);
  }
  ...
  r1.xyzw = t3.SampleBias(s1_s, r1.xy, cb0[29].x).xyzw;
  r0.w = r1.w * 2 + -1;
  r1.x = r0.w >= 0 ? 1 : -1;
  r0.w = 1 + -abs(r0.w);
  r0.w = sqrt(r0.w);
