  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[133].z > 0) {
    r1.xy = -cb0[133].xy + v1.xy;
    r1.yz = cb0[133].zz * abs(r1.xy) * min(1.f, injectedData.fxVignette);
    r1.x = cb0[132].w * r1.y;
    r1.x = dot(r1.xz, r1.xz);
    r1.x = 1 + -r1.x;
    r1.x = max(0, r1.x);
    r1.x = log2(r1.x);
    r1.x = cb0[133].w * r1.x * max(1.f, injectedData.fxVignette);
    r1.x = exp2(r1.x);
    r1.yzw = float3(1,1,1) + -cb0[132].xyz;
    r1.xyz = r1.xxx * r1.yzw + cb0[132].xyz;
  ...
  r1.x = cb0[128].z * r0.z;
  r1.x = floor(r1.x);
  r0.xy = cb0[128].zz * r0.xy;
  r1.yz = float2(0.5,0.5) * cb0[128].xy;
  r2.yz = r0.xy * cb0[128].xy + r1.yz;
  r2.x = r1.x * cb0[128].y + r2.y;
  r3.xyzw = t2.SampleLevel(s0_s, r2.xz, 0).xyzw;
  r0.x = cb0[128].y;
  r0.y = 0;
  r0.xy = r2.xz + r0.xy;
  r2.xyzw = t2.SampleLevel(s0_s, r0.xy, 0).xyzw;
  r0.x = r0.z * cb0[128].z + -r1.x;
