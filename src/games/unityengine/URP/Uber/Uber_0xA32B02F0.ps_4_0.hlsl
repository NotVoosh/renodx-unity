  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = cb0[139].xxxx * r0.xyzw * CUSTOM_CHROMATIC_ABERRATION;
  ...
  r1.yzw = cb0[133].xxx * r3.xyz * CUSTOM_BLOOM;
  r0.x = r1.x;
  r0.y = r2.y;
  r0.xyz = r1.yzw * cb0[133].yzw + r0.xyz;
  if (cb0[141].z > 0) {
    r1.xy = -cb0[141].xy + v1.xy;
    r1.yz = cb0[141].zz * abs(r1.xy) * min(1.f, CUSTOM_VIGNETTE);
    r1.x = cb0[140].w * r1.y;
    r0.w = dot(r1.xz, r1.xz);
    r0.w = 1 + -r0.w;
    r0.w = max(0, r0.w);
    r0.w = log2(r0.w);
    r0.w = cb0[141].w * r0.w * max(1.f, CUSTOM_VIGNETTE);
    r0.w = exp2(r0.w);
    r1.xyz = float3(1,1,1) + -cb0[140].xyz;
    r1.xyz = r0.www * r1.xyz + cb0[140].xyz;
    r0.xyz = r1.xyz * r0.xyz;
  }
  r0.xyz = cb0[131].www * r0.xyz;
  if (cb0[132].w > 0) {
    r1.xyz = renodx::color::srgb::EncodeSafe(r0.xyz);
    r2.xyz = handleUserLUT(r0.xyz, t3, s0_s, cb0[132].xyz);
  ...
  r0.xyw = cb0[131].zzz * r0.xyz;
  r0.w = floor(r0.w);
  r1.xy = float2(0.5,0.5) * cb0[131].xy;
  r1.yz = r0.xy * cb0[131].xy + r1.xy;
  r1.x = r0.w * cb0[131].y + r1.y;
  r2.xyzw = t2.SampleLevel(s0_s, r1.xz, 0).xyzw;
  r0.x = cb0[131].y;
  r0.y = 0;
  r0.xy = r1.xz + r0.xy;
  r1.xyzw = t2.SampleLevel(s0_s, r0.xy, 0).xyzw;
  r0.x = r0.z * cb0[131].z + -r0.w;
  r0.yzw = r1.xyz + -r2.xyz;
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
  } else {
    r0.xyz = renodx::lut::SampleTetrahedral(t2, r0.xyz, cb0[131].z + 1u);
  }
