  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[146].w > 0) {
    ...
    r3.xyz = handleUserLUT(r0.xyz, t3, s0_s, cb0[146].xyz, 1);
  ...
  r0.xyz = r0.xxx * r0.yzw + r3.xyz;
    ...
    r0.xyz = renodx::lut::SampleTetrahedral(t2, r0.xyz, cb0[145].z + 1u);
  }
  ...
  float3 newPeak = renodx::lut::Sample(t2, s0_s, lutShaper((injectedData.toneMapPeakNits / injectedData.toneMapGameNits), false, 1), cb0[145].z + 1u) * injectedData.toneMapGameNits;
