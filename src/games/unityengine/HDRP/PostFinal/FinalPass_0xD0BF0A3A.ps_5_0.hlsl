  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.r = renodx::color::y::from::BT709(r3.rgb);
  ...
  r3.g = renodx::color::y::from::BT709(r3.gba);
  r3.z = r3.x + r3.y;
  r1.zw = float2(0,0);
  ...
  r1.g = renodx::color::y::from::BT709(r1.gba);
  r1.z = r1.x + r1.y;
  r2.yw = r3.zz + -r1.zz;
  r1.zw = r3.xy + r1.xy;
  r1.w = r1.z + -r1.w;
  ...
  r2.a = renodx::color::y::from::BT709(r4.rgb);
  r3.z = min(r1.x, r3.y);
  r1.x = max(r1.x, r3.y);
  r1.x = max(r1.x, r1.y);
  r1.y = min(r3.z, r1.y);
  ...
  r0.y = max(r0.y, r1.x);
  r0.z = min(r0.z, r1.y);
  r0.yzw = (r2.w < r0.z || r2.w > r0.y) ? r2.xyz : r4.xyz;
  r2.xy = cb0[2].xy * r1.zw;
  r1.xy = cb1[48].xy * r1.zw;
  r2.z = cb0[2].z;
  r1.w = t2.SampleBias(s1_s, r2.xyz, cb1[79].y).w;
  r1.w = r1.w * 2 + -1;
  r2.x = 1 + -abs(r1.w);
  r1.w = (r1.w >= 0) ? 1 : -1;
  r2.x = sqrt(r2.x);
