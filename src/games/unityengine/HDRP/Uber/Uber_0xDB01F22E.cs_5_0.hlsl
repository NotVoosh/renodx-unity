...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r2.xy = r2.xy * r0.ww;
  r2.xy = cb1[0].xx * r2.xy * CUSTOM_CHROMATIC_ABERRATION;
  r2.zw = cb0[40].xy * -r2.xy;
  ...
  r2.z = (int)r0.w;
  r2.xy = -r2.xy / r2.zz;
  r3.xy = -cb0[40].zw * float2(0.5,0.5) + float2(1,1);
  r4.y = 0;
  r5.xyz = float3(0,0,0);
  r6.xyz = float3(0,0,0);
  r3.zw = r1.zw;
  ...
  if ((uint)cb1[1].z == 0) {
    r0.xy = r1.xy * cb0[40].zw + -cb1[1].xy;
