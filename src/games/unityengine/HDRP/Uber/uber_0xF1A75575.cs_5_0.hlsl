...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r2.xy = r2.xy * r0.ww;
  r2.xy = cb1[0].xx * r2.xy * injectedData.fxCA;
  ...
  r0.xy = cb0[50].xy * r3.xy;
  r3.xyzw = t0.SampleLevel(s0_s, r0.xyz, 0).xyzw;
  if (cb1[7].z != 0) {
    r4.xy = cb0[50].xy * r1.zw;
    ...
    if (cb1[7].w != 0) {
      ...
      r3.xyz = r0.xyz * cb1[7].yyy * injectedData.fxLens + r3.xyz;
    }
    r2.xyz = r3.xyz;
  }
  if ((uint)cb1[1].z == 0) {
    ...
    r1.x = r0.w * 0.305306011 + 0.682171111;
    r1.x = r0.w * r1.x + 0.012522878;
    r0.w = r1.x * r0.w;
  ...
  r1.x = saturate(r3.w * cb1[13].x + cb1[13].y);
  r1.yzw = r0.xyz + -r3.xyz;
  r1.xyz = r1.xxx * r1.yzw + r3.xyz;
  r3.xyz = (cb1[12].w == 0.0) ? (injectedData.toneMapType >= 2.f ? rolloff(r1.xyz, 0.85f) : r1.xyz) : r0.xyz;
  r3.w = saturate(r3.w);
  u0[vThreadID] = r3;
  return;
}
