...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r2.x = (int)r0.w;
  r1.zw = -r1.zw / r2.xx;
  r2.yz = -cb0[51].zw * float2(0.5,0.5) + float2(1,1);
  r3.y = 0;
  r4.xyz = float3(0,0,0);
  r5.xyz = float3(0,0,0);
  r3.zw = r1.xy;
  ...
  if (cb1[12].x != 0) {
    ...
    if (r0.x != 0) {
      ...
      r2.xyz = t4.SampleLevel(s2_s, r0.xyz, 0).xyz;
        ...
        r2.rgb = renodx::lut::SampleTetrahedral(t4, r0.rgb, 1 / cb1[6].x);
      }
    }
  }
