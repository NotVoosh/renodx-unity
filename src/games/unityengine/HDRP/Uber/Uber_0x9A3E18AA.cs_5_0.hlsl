...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  if (cb1[5].w > 0) {
    ...
    r4.x = (abs(r0.w) > 1) ? r4.x : 0;
    r3.z = r3.z * r3.w + r4.x;
    r0.w = min(1, r0.w);
    r0.w = (r0.w < -r0.w) ? -r3.z : r3.z;
    r0.w = r2.w * r0.w + -1;
  ...
  r2.x = (int)r0.w;
  r1.xy = -r1.xy / r2.xx;
  r2.yw = -cb0[40].zw * float2(0.5,0.5) + float2(1,1);
  r4.y = 0;
  r5.xyz = float3(0,0,0);
  r6.xyz = float3(0,0,0);
  r3.zw = r1.zw;
  ...
  while (true) {
    ...
    if (cb1[5].w > 0) {
      ...
      r8.w = (abs(r4.w) > 1) ? r8.w : 0;
      r6.w = r6.w * r8.z + r8.w;
      r4.w = min(1, r4.w);
      r4.w = (r4.w < -r4.w) ? -r6.w : r6.w;
      r4.w = r5.w * r4.w + -1;
      r8.xy = r7.xy * r4.ww + r7.zw;
    }
    r7.xy = min(r8.xy, r2.yw);
    r0.xy = cb0[41].xy * r7.xy;
  ...
  if (cb1[7].z != 0) {
    ...
    r0.xy = min(cb0[41].xy, r2.xy);
    r5.xyz = t1.SampleLevel(s0_s, r0.xyz, 0).xyz;
    r0.xy = min(cb0[41].xy, r2.zw);
