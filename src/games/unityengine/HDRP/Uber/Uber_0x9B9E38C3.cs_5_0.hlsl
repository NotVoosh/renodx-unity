...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r2.xy = -cb0[42].zw * float2(0.5,0.5) + float2(1,1);
  ...
  if ((uint)cb1[1].z == 0) {
    r1.xy = r1.xy * cb0[42].zw + -cb1[1].xy;
  ...
  if (cb1[12].x != 0) {
    r0.xyz = lutShaper(r3.xyz);
  } else {
    r1.xyz = cb1[6].zzz * r3.xyz;
  ...
  r0.w = saturate(r2.w * cb1[13].x + cb1[13].y);
