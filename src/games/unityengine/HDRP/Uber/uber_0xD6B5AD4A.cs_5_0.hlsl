...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r1.xy = r1.xy * cb0[42].zw + float2(-0.5, -0.5);
  ...
  r2.x = (int)r0.w;
  r1.xy = -r1.xy / r2.xx;
  r2.yw = -cb0[42].zw * float2(0.5, 0.5) + float2(1, 1);
  r4.y = 0;
  r5.xyz = float3(0, 0, 0);
  r6.xyz = float3(0, 0, 0);
  r3.zw = r1.zw;
  ...
  r0.xy = cb0[43].xy * r2.xy;
  r2.xyzw = t0.SampleLevel(s0_s, r0.xyz, 0).xyzw;
  if (cb1[7].z != 0) {
    r3.zw = cb0[43].xy * r3.xy;
    ...
    r2.xyz = cb1[7].xxx * r4.xyz * CUSTOM_BLOOM + r1.xyz;
    if (cb1[7].w != 0) {
