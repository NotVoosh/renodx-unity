...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r2.z = (int)r0.w;
  r2.xy = -r2.xy / r2.zz;
  r3.xy = -cb0[48].zw * float2(0.5,0.5) + float2(1,1);
  r4.y = 0;
  r5.xyz = float3(0,0,0);
  r6.xyz = float3(0,0,0);
  r3.zw = r1.zw;
  ...
  if ((uint)cb1[1].z == 0) {
    r0.xy = r1.xy * cb0[48].zw + -cb1[1].xy;
    r0.yz = cb1[2].xx * abs(r0.yx) * min(1, CUSTOM_VIGNETTE);
    r0.w = cb0[48].x / cb0[48].y;
    r0.w = -1 + r0.w;
    r0.w = cb1[2].w * r0.w + 1;
    r0.x = r0.z * r0.w;
