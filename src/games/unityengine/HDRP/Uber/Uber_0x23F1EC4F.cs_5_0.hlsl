...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r1.xy = r1.xy * cb0[40].zw + float2(-0.5,-0.5);
  ...
  if (cb1[5].w > 0) {
    ...
    r3.y = (abs(r0.w) > 1) ? r3.y : 0;
    r2.w = r2.w * r3.x + r3.y;
    r0.w = min(1, r0.w);
    r0.w = (r0.w < -r0.w) ? -r2.w : r2.w;
    r0.w = r2.z * r0.w + -1;
    r2.xy = r1.xy * r0.ww + r1.zw;
  }
  r1.xy = -cb0[40].zw * float2(0.5,0.5) + float2(1,1);
  r1.xy = min(r2.xy, r1.xy);
  r0.xy = cb0[41].xy * r1.xy;
  r1.xyz = t0.SampleLevel(s0_s, r0.xyz, 0).xyz;
  if (cb1[7].z != 0) {
    r2.zw = cb0[41].xy * r2.xy;
    ...
    r0.xy = min(cb0[41].xy, r6.xy);
    r7.xyz = t1.SampleLevel(s0_s, r0.xyz, 0).xyz;
    r0.xy = min(cb0[41].xy, r6.zw);
    ...
    r0.xy = min(cb0[41].xy, r3.xy);
    r5.xyz = t1.SampleLevel(s0_s, r0.xyz, 0).xyz;
    r0.xy = min(cb0[41].xy, r3.zw);
    ...
    r1.xyz = cb1[7].xxx * r3.xyz * CUSTOM_BLOOM + r1.xyz;
    if (cb1[7].w != 0) {
  ...
  if (cb1[12].x != 0) {
    ...
    r1.xyz = t3.SampleLevel(s1_s, r0.xyz, 0).xyz;
      ...
      r1.xyz = renodx::lut::SampleTetrahedral(t3, r0.xyz, 1 / cb1[6].x);
    }
  }
