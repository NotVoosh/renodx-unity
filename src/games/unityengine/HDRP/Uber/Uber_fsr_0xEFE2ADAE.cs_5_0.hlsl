...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r1.zw = -cb0[51].zw * float2(0.5,0.5) + float2(1,1);
  r1.zw = min(r1.xy, r1.zw);
  r0.xy = cb0[54].xy * r1.zw;
  ...
  if (cb1[12].x != 0) {
    ...
    if (cb1[6].w != 0) {
      ...
      r2.xyz = t3.SampleLevel(s1_s, r0.xyz, 0).xyz;
        ...
        r2.xyz = renodx::lut::SampleTetrahedral(t3, r0.xyz, 1 / cb1[6].x);
      }
    }
  }
  r0.xyzw = renodx::math::SignSqrt(r2.xyzx);
  u0[vThreadID] = r0;
  return;
}