...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r1.xyzw = float4(-1,-1,-1,-1) + cb0[51].xyxy;
  ...
  r2.xyzw = cb0[50].zwzw * r2.xyzw;
  r4.xyzw = float4(0.5,0.5,0.5,0.5) * cb0[51].zwzw;
  r5.xyz = (uint3)vThreadID.xyz;
  r4.xyzw = r5.xyxy * cb0[51].zwzw + r4.xyzw;
  ...
  r2.xyzw = cb0[54].xyxy * r2.xyzw;
  r4.xyzw = cb0[54].xyxy * r6.zwxy;
  r5.xy = r4.zw;
