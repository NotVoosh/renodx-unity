...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r1.xyzw = float4(-1,-1,-1,-1) + cb0[40].xyxy;
  ...
  r1.w = renodx::color::y::from::BT709(saturate(r5.xyz));
  r2.xy = r3.yx + r1.zw;
  r2.yw = r2.yy + -r2.xx;
  r3.z = r3.x + r3.y;
  r3.w = r1.w + r1.z;
  ...
  r2.xyzw = cb0[40].zwzw * r2.xyzw;
  r4.xyzw = float4(0.5,0.5,0.5,0.5) * cb0[40].zwzw;
  r5.xyz = (uint3)vThreadID.xyz;
  r4.xyzw = r5.xyxy * cb0[40].zwzw + r4.xyzw;
  ...
  r2.xyzw = cb0[41].xyxy * r2.xyzw;
  r4.xyzw = cb0[41].xyxy * r6.zwxy;
  r5.xy = r4.zw;
  r5.xyw = t0.SampleLevel(s0_s, r5.xyz, 0).xyz;
  r4.z = r5.z;
  r5.w = saturate(r5.xywx);
  r6.xy = r2.zw;
  r2.z = r4.z;
  ...
  r3.z = renodx::color::y::from::BT709(saturate(r4.wyz));
  ...
  r0.y = min(r0.y, r0.z);
  r0.x = max(r0.x, r0.w);
  r0.xyzw = r3.z < r0.y || r3.z > r0.x ? r2.xyzw : r4.xyzw;
  u0[vThreadID] = r0;
  return;
}