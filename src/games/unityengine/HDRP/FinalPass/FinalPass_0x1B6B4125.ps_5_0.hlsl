  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xy = cb0[1].zw + r1.xy;
  r1.xy = r1.xy / cb0[2].xy;
  r2.xy = r2.xy / cb0[1].xy;
  r2.xy = (r2.xy >= -r2.xy) ? frac(abs(r2.xy)) : -frac(abs(r2.xy));
  r2.xy = cb0[1].xy * r2.xy;
  r2.xy = (uint2)r2.xy;
  r2.zw = float2(0,0);
