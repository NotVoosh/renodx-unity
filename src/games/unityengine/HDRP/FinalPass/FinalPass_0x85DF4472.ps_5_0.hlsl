  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.y = renodx::color::y::from::BT709(r1.yzw);
  r1.z = r1.x + r1.y;
  r2.yw = r3.zz + -r1.zz;
  r1.zw = r3.xy + r1.xy;
  r1.w = r1.z + -r1.w;
  ...
  r2.w = renodx::color::y::from::BT709(r4.xyz);
  r3.z = min(r1.x, r3.y);
  r1.x = max(r1.x, r3.y);
  r1.x = max(r1.x, r1.y);
  r1.y = min(r3.z, r1.y);
  ...
  r0.y = renodx::color::y::from::BT709(r3.yzw);
  r0.z = min(r0.y, r3.x);
  r0.y = max(r0.y, r3.x);
  r0.y = max(r0.y, r1.x);
  r0.z = min(r0.z, r1.y);
  r0.yzw = (r0.y < r2.w) || (r2.w < r0.z) ? r2.xyz : r4.xyz;
  ...
  r1.xyz = cb0[0].xxx * r1.xyz * CUSTOM_FILM_GRAIN;
  r1.w = renodx::color::y::from::BT709(saturate(r0.yzw));
  r1.w = sqrt(r1.w);
  r1.w = cb0[0].y * -r1.w + 1;
