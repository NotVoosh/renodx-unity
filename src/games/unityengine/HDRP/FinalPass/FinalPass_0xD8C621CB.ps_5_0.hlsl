  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = saturate(r0.w);
  r3.y = renodx::color::y::from::BT709(saturate(r0.xyz));
  r3.z = min(r3.y, r3.x);
  r3.x = max(r3.y, r3.x);
  r2.x = max(r3.x, r2.x);
  r1.x = min(r3.z, r1.x);
  r0.xyz = (r1.w > r2.x) || (r1.w < r1.x) ? r4.xyz : r2.yzw;
  r2.xy = cb0[2].xy * r1.yz;
  if(injectedData.fxFilmGrainType == 0.f){
  r1.xw = r1.yz * cb0[1].xy + cb0[1].zw;
  r1.x = t1.Sample(s0_s, r1.xw).w;
  r1.x = -0.5 + r1.x;
  r1.x = r1.x + r1.x;
  r1.xyzw = r1.xxxx * r0.xyzw;
  r1.xyzw = cb0[0].xxxx * r1.xyzw * injectedData.fxFilmGrain;
  r2.w = renodx::color::y::from::BT709(saturate(r0.xyz));
  r2.w = sqrt(r2.w);
  r2.w = cb0[0].y * -r2.w + 1;
  r0.xyzw = r1.xyzw * r2.wwww + r0.xyzw;
  } else {
    r0.xyz = applyFilmGrain(r0.xyz, v1);
  }
  o0.w = r0.w;
  r2.z = cb0[2].z;
  r0.w = t2.Sample(s0_s, r2.xyz).w;
  r0.w = r0.w * 2 + -1;
  r1.x = 1 + -abs(r0.w);
  r0.w = r0.w >= 0 ? 1 : -1;
  r1.x = sqrt(r1.x);
