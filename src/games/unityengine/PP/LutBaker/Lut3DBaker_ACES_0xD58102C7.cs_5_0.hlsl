...
if (float(vThreadID.x) < cb0[0].x && float(vThreadID.y) < cb0[0].x && float(vThreadID.z) < cb0[0].x) {
    ...
    r0.x = saturate(dot(r1.xyz, float3(0.212672904,0.715152204,0.0721750036)));
    r0.y = 20 * r0.x;
    r0.y = min(1, r0.y);
    r0.yzw = cb0[7].xyz * r0.yyy + r1.xyz;
    r2.xyz = r1.xyz + -r0.yzw;
    r0.yzw = r0.xxx * r2.xyz + r0.yzw;
    r1.xyz = r1.xyz * cb0[9].xyz + -r0.yzw;
    r0.yzw = r0.xxx * r1.xyz + r0.yzw;
    r1.x = dot(r0.yzw, float3(0.212672904,0.715152204,0.0721750036));
    r1.yzw = -r1.xxx + r0.yzw;
    r1.xyz = r1.yzw * float3(1.5,1.5,1.5) + r1.xxx;
    ...
    r0.xyz = Ap1AcesTonemap(r0.xyz, 0, 0.7811);
    r0.w = 1;
    u0[vThreadID.xyz] = r0;
  }
  return;
