  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = lerp(preCG, r1.yzw, CUSTOM_INTERNAL_LUT_STRENGTH);
  ...
  if (RENODX_TONE_MAP_TYPE != 0.f) {
    o0.xyz = renodx::tonemap::UpgradeToneMap(hdrColor, min(1.f, curvesInput), o0.xyz, CUSTOM_INTERNAL_LUT_STRENGTH);
  } else {
    o0.xyz = lerp(curvesInput, o0.xyz, CUSTOM_INTERNAL_LUT_STRENGTH);
  }*/
  /*if (RENODX_TONE_MAP_TYPE != 0.f) {
