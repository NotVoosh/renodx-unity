...
float4 r0,r1,r2;
  ...
  r0.z = r0.z + -r0.y;
  r1.yw = float2(0.5,0);
  r2.xyzw = t2.Sample(s1_s, r1.xy).yxzw;
  r0.xz = r2.yy * r0.xz;
  r2.xz = r0.xz / r0.yy;
...
float setParam(float3 params){
  [branch]
  if(params.x == 1.5 && params.y == 1.05792964 && params.z == 2.37841415) return 1;  // Dreamfall Chapters
  if(params.x == 1.0 && params.y == 1.00450861 && params.z == 1.07177341) return 2;  // Dreamfall Chapters
  if(params.x == 1.20000005 && params.y == 1.01811504 && params.z == 1.14869833) return 3;  // Dreamfall Chapters
  if(params.x == 0.80000001 && params.y == 1.0 && params.z == 2.0) return 4;  // Dreamfall Chapters
  if(params.x == 0.69999999 && params.y == 1.01811504 && params.z == 1.0) return 5;  // Dreamfall Chapters
  if(params.x == 1.0 && params.y == 1.00450861 && params.z == 2.0) return 6;  // Dreamfall Chapters
  if(params.x == 1.0 && params.y == 1.0 && params.z == 2.0) return 7;  // Dreamfall Chapters
  if(params.x == 1.0 && params.y == 1.00450861 && params.z == 1.41421354) return 8;  // Dreamfall Chapters
  if(params.x == 0.85000002 && params.y == 1.00268805 && params.z == 1.14869833) return 9;  // Dreamfall Chapters
  if(params.x == 0.69999999 && params.y == 1.0 && params.z == 1.0) return 10;  // Dreamfall Chapters
  if(params.x == 1.23000002 && params.y == 1.0 && params.z == 0.70710677) return 11;  // Dreamfall Chapters
  if(params.x == 1.0 && params.y == 1.00450861 && params.z == 4.0) return 12;  // Dreamfall Chapters
else return 0;
}
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = cb0[12].y / r0.x;
  r0.x = min(cb0[12].w, r0.x);
  r0.x = max(cb0[12].z, r0.x);
  ...
  config.type = param == 0.f ? 0.f : min(3, injectedData.toneMapType);
