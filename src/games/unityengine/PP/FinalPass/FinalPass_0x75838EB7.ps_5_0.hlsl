  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyz = t1.Gather(s1_s, r0.xy).xyz;
  r3.xyz = t1.Gather(s1_s, r0.xy, int2(-1, -1)).xzw;
  r0.z = max(r2.x, r1.w);
  r0.w = min(r2.x, r1.w);
  r0.z = max(r2.z, r0.z);
  r0.w = min(r2.z, r0.w);
  ...
  r2.w = 0.125 * r0.z;
  r0.z = r0.z + -r0.w;
  r0.w = max(0.0625, r2.w);
  if (r0.z >= r0.w) {
    r0.w = t1.SampleLevel(s1_s, r0.xy, 0, int2(1, -1)).w;
    ...
    r0.x = abs(r0.x) + r0.w;
    r0.w = r3.z + r2.w;
    bool isHorizontal = r2.y >= r0.x;
    r0.z = r0.z * 2 + r0.w;
    r0.w = isHorizontal ? r3.y : r3.x;
    r2.x = isHorizontal ? r2.x : r2.z;
    r2.y = isHorizontal ? cb0[28].y : cb0[28].x;
    ...
    r0.z = isHorizontal ? cb0[28].x : 0;
    r2.w = isHorizontal ? 0 : cb0[28].y;
                ...
                if (notReachedBoth) {
                  ...
                  if (notReachedBoth) {
                    ...
                    if (notReachedBoth) {
                      ...
                      r3.x = reached1 ? r3.x : r4.y;
                      r0.w = -r0.w * 0.5 + r3.y;
                      r3.y = reached2 ? r3.y : r0.w;
                      reached1 = abs(r3.x) >= r2.x;
                      reached2 = abs(r3.y) >= r2.x;
                      r0.w = -r0.z * 8 + r4.x;
                      r4.x = reached1 ? r4.x : r0.w;
                      r0.w = -r2.w * 8 + r4.z;
                      r4.z = reached1 ? r4.z : r0.w;
                      r0.z = r0.z * 8 + r5.x;
  ...
  r0.xy = v1.xy * cb0[27].xy + cb0[27].zw;
