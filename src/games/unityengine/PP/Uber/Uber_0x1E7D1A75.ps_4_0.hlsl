  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.xyzw = saturate(r0.zywy * cb0[34].xxxx + r2.zwzw);
  r4.xyzw = cb0[26].xxxx * r4.xyzw;
  r5.xyzw = t3.Sample(s3_s, r4.xy).xyzw;
  r3.xyzw = r5.xyzw + r3.xyzw;
  r4.xyzw = t3.Sample(s3_s, r4.zw).xyzw;
  r3.xyzw = r4.xyzw * float4(2,2,2,2) + r3.xyzw;
  r0.xy = saturate(r0.xy * cb0[34].xx + r2.zw);
  ...
  r4.xyzw = float4(0.0625,0.0625,0.0625,0.0625) * r0.xyzw;
  ...
  if (cb0[40].y < 0.5) {
    ...
    r1.xyzw = t6.Sample(s6_s, r2.zw).xyzw;
  ...
  r2.xyzw = t5.Sample(s5_s, r1.xz).xyzw;
  r3.x = cb0[36].y;
  r3.y = 0;
  r0.zw = r3.xy + r1.xz;
