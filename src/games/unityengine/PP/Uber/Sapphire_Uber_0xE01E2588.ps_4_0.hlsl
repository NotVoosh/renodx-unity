  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = r1.xyz * cb0[4].zzz * CUSTOM_BLOOM + r0.xyz;
  r1.w = exp2(cb0[3].y);
  r2.x = 10 * cb0[3].z;
  r2.y = cb0[3].w * 0.25 + 1;
  ...
  if (asint(cb0[3].x) == 1) {
    ...
    if (asint(cb0[3].x) == 2) {
      ...
      if (asint(cb0[3].x) == 3) {
        ...
        r1.xyz = r4.xyz * float3(0.0500000007,0.0500000007,0.0500000007) + r3.xyz;
      } else {
        if (asint(cb0[3].x) == 4) {
          r3.xyz = float3(-0.200000003,-0.200000003,-0.200000003) + r1.xyz;
          r3.xyz = r3.xyz * float3(1.00999999,1.00999999,1.00999999) + float3(0.200000003,0.200000003,0.200000003);
          ...
          if (asint(cb0[3].x) == 5) {
            ...
            r4.xyz = r5.xyz * float3(0.100000001,0.100000001,0.100000001) + r4.xyz;
            ...
            if (asint(cb0[3].x) == 6) {
              ...
              while (true) {
                ...
                while (true) {
                  ...
                  r10.xyz = r10.xyz * r1.www + float3(-0.200000003,-0.200000003,-0.200000003);
                  r10.xyz = r10.xyz * r2.yyy + float3(0.200000003,0.200000003,0.200000003);
