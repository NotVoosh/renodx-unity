  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[44].y < 0.5) {
    ...
    r0.w = cb0[29].x / cb0[29].y;
    r0.w = -1 + r0.w;
    r0.w = cb0[43].w * r0.w + 1;
    r2.x = r2.z * r0.w;
    ...
    r0.w = max(0, r0.w);
    r0.w = log2(r0.w);
    r0.w = cb0[43].y * r0.w * max(1.f, injectedData.fxVignette);
    r0.w = exp2(r0.w);
    r1.zw = r1.zw * cb0[41].xy + cb0[41].wz;
    r2.xyzw = t4.Sample(s4_s, r1.zw).xyzw;
    r2.xyz = cb0[40].yzw * r2.xyz + float3(-1,-1,-1);
    ...
    r1.xyz = float3(1,1,1) + -cb0[40].yzw;
    r1.xyz = r0.www * r1.xyz + cb0[40].yzw;
    r1.xyz = r0.xyz * r1.xyz + -r0.xyz;
    r4.xyz = cb0[44].xxx * r1.xyz + r0.xyz;
    r0.x = -1 + r3.w;
    r4.w = r0.w * r0.x + 1;
  }
