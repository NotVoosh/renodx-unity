  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[40].y < 0.5) {
    ...
    r3.yzw = float3(1,1,1) + -cb0[37].xyz;
    r3.yzw = r3.xxx * r3.yzw + cb0[37].xyz;
    r3.yzw = r0.xyz * r3.yzw + -r0.xyz;
    r1.yzw = cb0[40].xxx * r3.yzw + r0.xyz;
    r0.x = -1 + r0.w;
    r2.w = r3.x * r0.x + 1;
  }
  ...
  r1.xyzw = t5.Sample(s5_s, r0.xyz).xyzw;
    ...
    r1.xyz = renodx::lut::SampleTetrahedral(t5, r0.xyz, 1 / cb0[36].x);
  }
  r0.xyz = r1.xyz;
