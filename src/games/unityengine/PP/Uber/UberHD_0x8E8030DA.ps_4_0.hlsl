  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = renodx::color::y::from::BT709(saturate(r2.xyz));
  r0.w = sqrt(r0.w);
  ...
  r3.xyz = r0.xyz * r0.www + r2.xyz;
    ...
    r3.xyz = applyFilmGrain(r2.xyz, w1);
  }
