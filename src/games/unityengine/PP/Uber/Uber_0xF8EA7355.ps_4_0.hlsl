  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.xyz = float3(0.25,0.25,0.25) * r0.xyz;
  ...
  r4.xyz = r0.xyz * r0.www + r3.xyz;
    ...
    r4.xyz = applyFilmGrain(r3.xyz, w1);
  }
  r4.w = saturate(r4.w);
  ...
  if (CUSTOM_COUNT_OLD == CUSTOM_COUNT_NEW) {
    r4.xyz = PostToneMapScale(r4.xyz);
  }
  o0.xyzw = r4.xyzw;
  return;
}