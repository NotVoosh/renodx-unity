  ...
  out float4 o0 : SV_Target0)
{
  ...
  while (true) {
    ...
    r7.xyzw = t0.SampleLevel(s0_s, r7.xy, 0).xyzw;
    r8.xyzw = t4.SampleLevel(s4_s, r2.xy, 0).xyzw;
    r3.xyz = r8.xyz;
  ...
  r1.xy = cb0[26].xx * r1.xy;
  r6.xyzw = t2.Sample(s2_s, r1.xy).xyzw;
  ...
  r4.xyz = cb0[34].zzz * r4.xyz * CUSTOM_LENS;
  ...
  if (cb0[40].y < 0.5) {
    ...
    r3.yz = cb0[39].xx * abs(r1.yx) * min(1.f, CUSTOM_VIGNETTE);
  ...
  r4.xyz = r0.xyz * r0.www + r3.xyz;
    ...
    r4.xyz = applyFilmGrain(r3.xyz, v1);
  }
  r4.w = saturate(r4.w);
  r0.yzx = lutShaper(r4.xyz, false, 2);
