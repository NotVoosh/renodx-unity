  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = float4(-0.5,-0.5,-0.5,-0.5) + float4(v1.xy, w1.xy);
  ...
  r0.zw = float2(0.0250000004,0.0250000004) * r1.xy;
  r1.zw = r5.xy * r5.xy;
  r0.zw = r1.zw * float2(2,2) + r0.zw;
  r1.zw = float2(0.0250000004,0.0250000004) * r5.xy;
  r1.xy = r1.xy * float2(0.100000001,0.100000001) + r1.zw;
  ...
  r1.yz = r5.xy * float2(0.150000006,0.150000006) + r3.xy;
  ...
  r1.w = r6.x * 0.100000001 + 0.550000012;
  r7.xy = float2(0.5,0.5) + -r1.yz;
  r8.xyzw = float4(0.100000001,0.100000001,0.0200000014,0.0200000014) * r7.xyxy;
  ...
  r4.xy = r4.xy * float2(-0.5,0.800000012) + float2(1,0.100000001);
  r4.xy = saturate(r4.xy + r3.xy);
  r4.xy = cb0[30].zz * r4.xy;
  r9.xyzw = t4.Sample(s4_s, r4.xy).xyzw;
  r4.xy = r4.zw * float2(-0.5,-0.5) + r3.xy;
  r4.xy = saturate(float2(0.800000012,0.800000012) + r4.xy);
  r4.xy = cb0[30].zz * r4.xy;
  r4.xyzw = t4.Sample(s4_s, r4.xy).xyzw;
  r4.xyzw = r9.xyzw + r4.xyzw;
  r4.xyzw = min(float4(0.100000001,0.100000001,0.100000001,0.100000001), r4.xyzw);
  r3.xyzw = r4.xyzw + r3.xyzw;
  r4.x = dot(r8.xy, r8.xy);
  r4.x = rsqrt(r4.x);
  r4.xy = r8.xy * r4.xx;
  r4.zw = r4.xy * r1.ww;
  r4.zw = r4.zw * float2(0.899999976,0.899999976) + v1.xy;
  r4.zw = frac(r4.zw);
  ...
  r4.xy = float2(0.0400000028,0.0400000028) * r7.xy;
  ...
  r3.xyzw = r4.xyzw * float4(0.200000003,0.200000003,0.200000003,0.200000003) + r3.xyzw;
  r1.x = -1 + r1.x;
  r1.x = r1.x * 0.75 + 1;
  r1.x = cb0[39].y * r1.x * CUSTOM_BLOOM;
  r1.xyzw = r3.xyzw * r1.xxxx;
  r3.xyz = cb0[39].zzz * r6.xyz * CUSTOM_LENS;
  r3.w = 0;
  r3.xyzw = float4(1,1,1,1) + r3.xyzw;
  r0.xyzw = r1.xyzw * r3.xyzw + r0.xyzw;
  r3.x = saturate(r2.w);
  r3.xy = float2(1.10000002,1.5) * r3.xx;
  r3.x = min(1, r3.x);
  r3.x = 1 + -r3.x;
