  ...
  out float4 o0 : SV_Target0)
{
  ...
  while (true) {
    ...
    r9.xyzw = t2.SampleLevel(s2_s, r4.xy, 0).xyzw;
    r3.yzw = r8.xyz * r9.xyz + r3.yzw;
    r1.xyz = r9.xyz + r1.xyz;
    r4.zw = r4.zw + r2.xy;
    r8.xy = r7.xy * cb0[3].xy + cb0[3].zw;
    r10.xyzw = t3.SampleLevel(s3_s, r8.xy, 0).xyzw;
    r8.xyzw = t4.SampleLevel(s4_s, r8.xy, 0).xyzw;
    r4.x = -0.5 + r8.x;
    r4.x = r4.x + r4.x;
    r5.xyz = r9.xyz;
  ...
  r4.xyzw = t5.Sample(s5_s, w2.xy).xyzw;
