  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xyz = r3.xyz * cb0[11].zzz * CUSTOM_LENS + r4.xyz;
  ...
  r2.xyzw = t10.Sample(s8_s, r1.xz).xyzw;
  r3.x = cb0[15].y;
  r3.y = 0;
  r0.zw = r3.xy + r1.xz;
  r1.xyzw = t10.Sample(s8_s, r0.zw).xyzw;
  r0.x = r0.x * cb0[15].z + -r0.y;
  r0.yzw = r1.xyz + -r2.xyz;
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
  } else {
    r0.xyz = renodx::lut::SampleTetrahedral(t10, r0.yzx, cb0[15].z + 1u);
  }
  ...
  r1.xyzw = t11.Sample(s1_s, r1.xy).xyzw;
  r0.w = r1.w * 2 + -1;
  r1.x = sign(r0.w);
  r0.w = 1 + -abs(r0.w);
  r0.w = sqrt(r0.w);
