  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.xyzw = t3.Sample(s4_s, r3.xy).xyzw;
  r3.xyzw = t3.Sample(s4_s, r3.zw).xyzw;
  r3.xyz = r3.zxy * float3(2,2,2) + r4.zxy;
  r2.xy = -r1.zy * cb0[11].xx + w2.xy;
  r4.xyzw = t3.Sample(s4_s, r2.xy).xyzw;
  ...
  r5.xyzw = t3.Sample(s4_s, w2.xy).xyzw;
  ...
  r3.xyzw = t4.Sample(s5_s, v2.xy).xyzw;
  ...
  r3.xyzw = t5.Sample(s6_s, r1.xz).xyzw;
  r2.z = cb0[12].y;
  r0.zw = r1.xz + r2.zw;
  r1.xyzw = t5.Sample(s6_s, r0.zw).xyzw;
