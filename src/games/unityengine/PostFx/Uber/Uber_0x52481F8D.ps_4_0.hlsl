  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyzw = t2.Sample(s4_s, r1.xy).xyzw;
  r1.xyzw = t2.Sample(s4_s, r1.zw).xyzw;
  r1.xyz = r1.zxy * float3(2,2,2) + r2.zxy;
  r2.xy = -r0.zy * cb0[11].xx + w2.xy;
  r2.xyzw = t2.Sample(s4_s, r2.xy).xyzw;
  r1.xyz = r2.zxy + r1.xyz;
  r2.xyzw = r0.zwxw * cb0[11].xxxx + w2.xyxy;
  r3.xyzw = t2.Sample(s4_s, r2.xy).xyzw;
  r2.xyzw = t2.Sample(s4_s, r2.zw).xyzw;
  r1.xyz = r3.zxy * float3(2,2,2) + r1.xyz;
  r3.xyzw = t2.Sample(s4_s, w2.xy).xyzw;
  ...
  r0.xyzw = t2.Sample(s4_s, r0.xy).xyzw;
  r3.xyzw = t2.Sample(s4_s, r2.xy).xyzw;
  r2.xyzw = t2.Sample(s4_s, r2.zw).xyzw;
  ...
  r1.xyz = r2.zxy * r1.xxx + r0.xyz;
  r2.xyzw = t3.Sample(s5_s, v2.xy).xyzw;
  r2.xyz = cb0[11].zzz * r2.zxy * CUSTOM_LENS;
  ...
  r2.y = 0;
  r0.yz = r2.xy + r1.xz;
  r1.xyzw = t4.Sample(s6_s, r1.xz).xyzw;
  r2.xyzw = t4.Sample(s6_s, r0.yz).xyzw;
