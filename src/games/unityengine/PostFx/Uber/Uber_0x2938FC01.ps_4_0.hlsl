  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyzw = t4.Sample(s5_s, r1.xy).xyzw;
  r1.xyzw = t4.Sample(s5_s, r1.zw).xyzw;
  ...
  r3.xyzw = t4.Sample(s5_s, w2.xy).xyzw;
  ...
  r0.xyzw = t4.Sample(s5_s, r0.xy).xyzw;
  r3.xyzw = t4.Sample(s5_s, r2.xy).xyzw;
  r2.xyzw = t4.Sample(s5_s, r2.zw).xyzw;
  ...
  r1.xyzw = t3.Sample(s4_s, w2.xy).xyzw;
  r0.w = -0.5 + r1.x;
  r0.w = r0.w + r0.w;
  ...
  r0.w = r0.w * r0.w;
  r1.y = r1.x * r0.w;
  r2.xyzw = t2.Sample(s3_s, w2.xy).xyzw;
  r0.w = r1.x * r0.w + r2.w;
  r0.w = -r1.y * r2.w + r0.w;
  r1.xyzw = t1.Sample(s0_s, w1.xy).xyzw;
  r3.xyzw = t0.Sample(s2_s, v1.xy).xyzw;
  r1.xyz = r3.xxx * r1.zxy;
  r2.xyz = r2.zxy * r3.xxx + -r1.xyz;
  ...
  r2.y = 0;
  r0.yz = r2.xy + r1.xz;
  r1.xyzw = t5.Sample(s6_s, r1.xz).xyzw;
  r2.xyzw = t5.Sample(s6_s, r0.yz).xyzw;
  ...
  r0.w = 1 + -r0.w;
  r0.w = r1.x * r0.w;
  r0.xyz = applyDither(r0.xyz, r0.w * (1.0 / 510.0), 1);
