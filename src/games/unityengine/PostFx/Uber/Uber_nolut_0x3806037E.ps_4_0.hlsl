  ...
  out float4 o0 : SV_Target0)
{
  ...
  /*r1.xyz = cb0[13].zzz * r0.zxy;
  r0.w = floor(r1.x);
  r1.x = r0.z * cb0[13].z + -r0.w;
  r2.xy = float2(0.5,0.5) * cb0[13].xy;
  r2.yz = r1.yz * cb0[13].xy + r2.xy;
  r2.x = r0.w * cb0[13].y + r2.y;
  r3.x = cb0[13].y;
  r3.y = 0;
  r1.yz = r3.xy + r2.xz;
  r2.xyzw = t3.Sample(s3_s, r2.xz).xyzw;
  r3.xyzw = t3.Sample(s3_s, r1.yz).xyzw;
