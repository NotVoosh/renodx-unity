  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyz = r1.xyz < float3(1,1,1) ? float3(1,1,1) : 0;
  ...
  r1.xyzw = t6.Sample(s7_s, r1.xy).xyzw;
  ...
  r2.xyzw = t7.Sample(s3_s, r1.xz).xyzw;
  r3.x = cb0[15].y;
  r3.y = 0;
  r0.zw = r3.xy + r1.xz;
  r1.xyzw = t7.Sample(s3_s, r0.zw).xyzw;
  r0.x = r0.x * cb0[15].z + -r0.y;
  r0.yzw = r1.xyz + -r2.xyz;
  r0.xyz = r0.xxx * r0.yzw + r2.xyz;
  } else {
    r0.xyz = renodx::lut::SampleTetrahedral(t7, r0.yzx, cb0[15].z + 1u);
  }
