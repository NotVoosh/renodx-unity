  ...
  out float4 o0 : SV_Target0)
{
  ...
  while (true) {
    ...
    r7.w = 0.5 + r7.w;
    r4.x = r7.w / r1.w;
    r8.xy = r4.zw * cb0[3].xy + cb0[3].zw;
    r8.xyzw = t1.SampleLevel(s0_s, r8.xy, 0).xyzw;
    r9.xyzw = t2.SampleLevel(s3_s, r4.xy, 0).xyzw;
    r3.yzw = r8.xyz * r9.xyz + r3.yzw;
    r1.xyz = r9.xyz + r1.xyz;
    r4.zw = r4.zw + r2.xy;
    r8.xy = r7.xy * cb0[3].xy + cb0[3].zw;
    r10.xyzw = t3.SampleLevel(s4_s, r8.xy, 0).xyzw;
    r8.xyzw = t4.SampleLevel(s5_s, r8.xy, 0).xyzw;
    r4.x = -0.5 + r8.x;
    r4.x = r4.x + r4.x;
    r5.xyz = r9.xyz;
    r6.xyzw = r10.xyzw * r5.xyzw + r6.xyzw;
  ...
  r3.xyzw = t5.Sample(s6_s, r2.xy).xyzw;
  r2.xyzw = t5.Sample(s6_s, r2.zw).xyzw;
  r2.xyz = r2.xyz * float3(2,2,2) + r3.xyz;
  r3.xy = -r1.zy * cb0[11].xx + w2.xy;
  r3.xyzw = t5.Sample(s6_s, r3.xy).xyzw;
  r2.xyz = r3.xyz + r2.xyz;
  r3.xyzw = r1.zwxw * cb0[11].xxxx + w2.xyxy;
  r4.xyzw = t5.Sample(s6_s, r3.xy).xyzw;
  r2.xyz = r4.xyz * float3(2,2,2) + r2.xyz;
  r4.xyzw = t5.Sample(s6_s, w2.xy).xyzw;
