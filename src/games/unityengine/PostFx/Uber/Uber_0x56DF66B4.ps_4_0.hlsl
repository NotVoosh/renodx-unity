  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yz = cb0[16].xx * abs(r0.yz) * min(1.f, CUSTOM_VIGNETTE);
  r0.x = r0.y * r0.x;
  r1.y = log2(r0.z);
  r1.x = log2(r0.x);
  ...
  r0.x = max(0, r0.x);
  r0.x = log2(r0.x);
  r0.x = cb0[16].y * r0.x * max(1.f, CUSTOM_VIGNETTE);
  r0.x = exp2(r0.x);
  ...
  r2.y = 0;
  r0.yz = r2.xy + r1.xz;
  r1.xyzw = t2.Sample(s4_s, r1.xz).xyzw;
  r2.xyzw = t2.Sample(s4_s, r0.yz).xyzw;
