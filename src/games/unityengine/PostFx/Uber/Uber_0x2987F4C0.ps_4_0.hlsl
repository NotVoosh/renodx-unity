  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = -1 + r0.w;
  r0.w = cb0[13].w * r0.w + 1;
  r1.xy = -cb0[12].xy + v1.xy;
  r1.xy = cb0[13].xx * abs(r1.xy) * min(1.f, injectedData.fxVignette);
  r0.w = r1.x * r0.w;
  r1.y = log2(r1.y);
  r1.x = log2(r0.w);
  r1.xy = cb0[13].zz * r1.xy;
  r1.xy = exp2(r1.xy);
  r0.w = dot(r1.xy, r1.xy);
  r0.w = 1 + -r0.w;
  r0.w = max(0, r0.w);
  r0.w = log2(r0.w);
  r0.w = cb0[13].y * r0.w * max(1.f, injectedData.fxVignette);
  r0.w = exp2(r0.w);
  r1.xyz = float3(1,1,1) + -cb0[11].zxy;
  r1.xyz = r0.www * r1.xyz + cb0[11].zxy;
  ...
  r0.xyz = r0.xxx * r0.yzw + r1.xyz;
    ...
    r0.xyz = renodx::lut::SampleTetrahedral(t5, r0.xyz, cb0[9].z + 1u);
  }
