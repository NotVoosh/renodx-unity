  ...
  out float4 o0 : SV_Target0)
{
  ...
  while (true) {
    ...
    r6.xyzw = t2.SampleLevel(s3_s, r2.xy, 0).xyzw;
  ...
  r4.xyzw = -r3.xywy * cb0[11].xxxx + w2.xyxy;
  r5.xyzw = t3.Sample(s4_s, r4.xy).xyzw;
  r4.xyzw = t3.Sample(s4_s, r4.zw).xyzw;
  r4.xyz = r4.zxy * float3(2,2,2) + r5.zxy;
  r2.xy = -r3.zy * cb0[11].xx + w2.xy;
  r5.xyzw = t3.Sample(s4_s, r2.xy).xyzw;
  r4.xyz = r5.zxy + r4.xyz;
  r5.xyzw = r3.zwxw * cb0[11].xxxx + w2.xyxy;
  r6.xyzw = t3.Sample(s4_s, r5.xy).xyzw;
  r4.xyz = r6.zxy * float3(2,2,2) + r4.xyz;
  r6.xyzw = t3.Sample(s4_s, w2.xy).xyzw;
  r4.xyz = r6.zxy * float3(4,4,4) + r4.xyz;
  r5.xyzw = t3.Sample(s4_s, r5.zw).xyzw;
  r4.xyz = r5.zxy * float3(2,2,2) + r4.xyz;
  r5.xyzw = r3.zywy * cb0[11].xxxx + w2.xyxy;
  r6.xyzw = t3.Sample(s4_s, r5.xy).xyzw;
  r4.xyz = r6.zxy + r4.xyz;
  r5.xyzw = t3.Sample(s4_s, r5.zw).xyzw;
  r4.xyz = r5.zxy * float3(2,2,2) + r4.xyz;
  r2.xy = r3.xy * cb0[11].xx + w2.xy;
  r3.xyzw = t3.Sample(s4_s, r2.xy).xyzw;
  r3.xyz = r4.xyz + r3.zxy;
  r3.xyz = cb0[11].yyy * r3.xyz * CUSTOM_BLOOM;
  ...
  r3.xyzw = t4.Sample(s5_s, r1.xz).xyzw;
  r2.z = cb0[12].y;
  r0.zw = r1.xz + r2.zw;
  r1.xyzw = t4.Sample(s5_s, r0.zw).xyzw;
  r0.x = r0.x * cb0[12].z + -r0.y;
  r0.yzw = r1.xyz + -r3.xyz;
  r0.xyz = r0.xxx * r0.yzw + r3.xyz;
  } else {
    r0.xyz = renodx::lut::SampleTetrahedral(t4, r0.yzx, cb0[12].z + 1u);
  }
