  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r2.z >= r2.w) {
    r3.xy = cb0[29].xy / cb0[26].xy;
    r2.w = t1.SampleLevel(s1_s, r0.xy, 0, int2(-1, -1)).w;
    r3.z = t1.SampleLevel(s1_s, r0.xy, 0, int2(1, 1)).w;
    r3.w = t1.SampleLevel(s1_s, r0.xy, 0, int2(1, -1)).w;
    ...
    r2.w = r2.w + r0.x;
    r0.x = r0.x + r3.z;
    r0.y = abs(r0.y) * 2 + abs(r4.w);
    r3.z = abs(r4.x) * 2 + abs(r3.w);
    r3.w = r2.y * -2 + r2.w;
    r0.x = r0.z * -2 + r0.x;
    r0.y = abs(r3.w) + r0.y;
    r0.x = abs(r0.x) + r3.z;
    ...
    r2.z = isHorizontal ? r3.x : 0;
    r2.w = isHorizontal ? 0 : r3.y;
    ...
    r5.xy = r3.xy + r2.zw;
    r3.x = r0.y * -2 + 3;
    r3.yw = saturate(r4.xy);
    r3.yw = cb0[26].zz * r3.yw;
    r3.y = t1.SampleLevel(s1_s, r3.yw, 0).w;
    r0.y = r0.y * r0.y;
    r4.zw = saturate(r5.xy);
    r4.zw = cb0[26].zz * r4.zw;
