  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.x = renodx::color::y::from::NTSC1953(r2.xyz);
  ...
  if (r2.x >= r2.y) {
    ...
    r3.z = renodx::color::y::from::NTSC1953(r6.xyz);
    r1.w = r1.w * r1.w;
    r6.xyz = t0.SampleLevel(s0_s, r5.xy, 0).xyz;
    r3.w = renodx::color::y::from::NTSC1953(r6.xyz);
    ...
    if (notReachedBoth) {
      if (!reached1) {
        ...
        r3.x = renodx::color::y::from::NTSC1953(r5.xyz);
      }
      if (!reached2) {
        r5.xyz = t0.SampleLevel(s0_s, r4.yw, 0).xyz;
        r3.y = renodx::color::y::from::NTSC1953(r5.xyz);
      }
      r2.y = -r1.x * 0.5 + r3.x;
