  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.y = renodx::color::y::from::BT709(saturate(r2.yzw));
  r2.z = r2.x + r2.y;
  r1.zw = float2(0,0);
  ...
  r2.z = renodx::color::y::from::BT709(saturate(r0.yzw));
  r2.w = min(r1.x, r2.y);
  r1.x = max(r1.x, r2.y);
  r1.x = max(r1.x, r0.x);
  r0.x = min(r2.w, r0.x);
  r3.xyz = t0.SampleBias(s0_s, v1.xy, cb0[19].x).xyz;
  r2.y = renodx::color::y::from::BT709(saturate(r3.xyz));
  r2.w = min(r2.y, r2.x);
  r2.x = max(r2.y, r2.x);
  r1.x = max(r2.x, r1.x);
  r0.x = min(r2.w, r0.x);
  ...
  r1.xy = v1.xy * cb0[130].xy + cb0[130].zw;
  r0.w = t1.SampleBias(s1_s, r1.xy, cb0[19].x).w;
  r0.w = -0.5 + r0.w;
  r0.w = r0.w + r0.w;
  r1.xyz = r0.xyz * r0.www;
  r1.xyz = cb0[129].xxx * r1.xyz * CUSTOM_FILM_GRAIN;
  r0.w = renodx::color::y::from::BT709(saturate(r0.xyz));
  r0.w = sqrt(r0.w);
  r0.w = cb0[129].y * -r0.w + 1;
