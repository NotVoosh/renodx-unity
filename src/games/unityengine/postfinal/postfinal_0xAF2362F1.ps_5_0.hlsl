  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.x = t1.SampleLevel(s1_s, r0.xy, 0, int2(0, -1)).y;
  r2.y = t1.SampleLevel(s1_s, r0.xy, 0, int2(-1, 0)).y;
  r2.z = max(r0.z, r1.y);
  r2.w = min(r0.z, r1.y);
  r2.z = max(r2.z, r0.w);
  r2.w = min(r2.w, r0.w);
  ...
  if (r2.z >= r2.w) {
    ...
    r3.y = t1.SampleLevel(s1_s, r0.xy, 0, int2(1, -1)).y;
    ...
    r3.w = t1.SampleLevel(s1_s, r4.zw, 0).y;
    ...
    if (notReachedBoth) {
      if (!reached1) {
        ...
        r3.x = t1.SampleLevel(s1_s, r4.yw, 0).y;
      }
      if (!reached2) {
        r4.yw = saturate(r5.xz);
        r4.yw = cb0[26].xx * r4.yw;
        r3.y = t1.SampleLevel(s1_s, r4.yw, 0).y;
      }
      r4.y = -r0.z * 0.5 + r3.x;
  ...
  r0.w = 1 + -r0.w;
  r0.w = r2.x * r0.w;
  r1.xyz = applyDither(r0.xyz, r0.w * (1.0 / 255.0), CUSTOM_GAMMA_SPACE != 0.f ? 0 : 1);
  if (CUSTOM_COUNT_OLD == CUSTOM_COUNT_NEW) {
    r1.xyz = PostToneMapScale(r1.xyz, CUSTOM_GAMMA_SPACE != 0.f);
