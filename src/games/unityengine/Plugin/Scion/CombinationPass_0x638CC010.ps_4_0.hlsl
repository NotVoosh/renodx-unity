  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xy = cb0[21].zz * r0.xy;
  r0.x = dot(r0.xy, r0.xy);
  r0.x = 1 + -r0.x;
  r0.x = max(0, r0.x);
  r0.x = r0.x * r0.x + -1;
  r0.x = cb0[21].y * r0.x + 1;
  r1.xyzw = t0.SampleLevel(s1_s, v1.xy, 0).xyzw;
  r0.yzw = cb0[22].xyz * r1.xyz;
  r1.xyz = -cb0[22].xyz * r1.xyz + r1.xyz;
  r0.xyz = r0.xxx * r1.xyz + r0.yzw;
  if(injectedData.fxFilmGrainType == 0.f){
  r0.w = v1.y * 541.169983 + v1.x;
  r0.w = cb0[23].x + r0.w;
  r0.w = sin(r0.w);
  r0.w = r0.w * 273351.5 + cb0[23].x;
  r0.w = frac(r0.w);
  r0.w = r0.w * 2 + -1;
  r0.w = cb0[21].x * r0.w * injectedData.fxFilmGrain;
