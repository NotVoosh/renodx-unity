  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.z = rsqrt(r0.z);
  r0.zw = r0.xy * r0.zz;
  r1.xyzw = cb0[17].wwzz * r0.xyxy * min(1.f, CUSTOM_VIGNETTE);
  r0.x = dot(r1.xy, r1.xy);
  r0.y = dot(r1.zw, r1.zw);
  r0.xy = float2(1,1) + -r0.xy;
  r0.xy = max(float2(0,0), r0.xy);
  r0.y = r0.y * r0.y + -1;
  r0.y = cb0[17].y * r0.y * max(1.f, CUSTOM_VIGNETTE) + 1;
  r0.x = -r0.x * r0.x + 1;
  r0.x = cb0[3].z * r0.x;
  r0.xz = r0.zw * r0.xx;
  r1.xy = cb0[18].ww * r0.xz * CUSTOM_CHROMATIC_ABERRATION;
  r0.xz = r0.xz * cb0[18].ww * CUSTOM_CHROMATIC_ABERRATION + v1.xy;
  ...
  r1.xyz = cb0[15].zzz * r1.xyz * max(0.1f, CUSTOM_BLOOM);
