  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = r1.xyz * float3(0.0625,0.0625,0.0625) + r0.xyz;
  r0.xyz = cb0[18].zzz * r0.xyz * CUSTOM_BLOOM;
  r0.w = 0.25 * cb0[21].w;
  ...
  r2.xyzw = t0.SampleLevel(s1_s, r1.zw, 0).xyzw;
  r2.xyz = float3(0.5,0.5,0) * r2.xyz;
  r3.xyzw = t0.SampleLevel(s1_s, v1.xy, 0).xyzw;
  r2.xyz = r3.xyz * float3(1,0,0) + r2.xyz;
  r0.w = cb0[21].w * r1.x;
  r1.xz = r1.xx * cb0[21].ww + v1.xy;
  r3.xyzw = t0.SampleLevel(s1_s, r1.xz, 0).xyzw;
  r4.xyzw = r0.wwww * float4(0.5,0.5,0.75,0.75) + v1.xyxy;
  r5.xyzw = t0.SampleLevel(s1_s, r4.xy, 0).xyzw;
  r4.xyzw = t0.SampleLevel(s1_s, r4.zw, 0).xyzw;
  ...
  r2.xyz = r0.xyz * cb0[19].yyy + -r1.xzw;
  ...
  r0.xyz = cb0[19].xxx * r1.xzw + r0.xyz;
  ...
  r2.y = 0.5 + r1.x;
  r2.x = 0.5 + r0.w;
  r2.xyzw = t3.SampleLevel(s5_s, r2.xy, 0).xyzw;
  r4.xyzw = t4.SampleLevel(s4_s, v1.xy, 0).xyzw;
  r1.xzw = r4.xyz * r2.xyz;
  r2.xyz = cb0[19].www * r1.xzw;
  r2.xyz = r2.xyz * r3.xyz + -r1.xzw;
  r1.xzw = cb0[19].zzz * r2.xyz + r1.xzw;
