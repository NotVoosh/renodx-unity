  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyzw = t3.Sample(s4_s, w1.xy).xyzw;
  r1.xyz = cb0[46].xxx * r1.xyz;
  r1.xyz = r1.xyz * r1.www;
  r0.xyz = cb0[48].www * r1.xyz + r0.xyz;
  r1.xyzw = t4.Sample(s5_s, w1.xy).xyzw;
  r1.xyz = cb0[46].xxx * r1.xyz;
  r1.xyz = r1.xyz * r1.www;
  r0.xyz = cb0[49].xxx * r1.xyz + r0.xyz;
  r1.xyzw = t5.Sample(s6_s, w1.xy).xyzw;
  r1.xyz = cb0[46].xxx * r1.xyz;
  r1.xyz = r1.xyz * r1.www;
