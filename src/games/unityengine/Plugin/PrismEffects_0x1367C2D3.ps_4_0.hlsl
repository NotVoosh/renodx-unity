  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = w1.xy * cb0[45].xy + cb0[45].zw;
  ...
  if (cb0[63].y > 0) {
    ...
    r2.xyzw = t2.Sample(s6_s, r1.xz).xyzw;
  ...
  if (cb0[6].x > 0) {
    ...
    r1.w = r1.w * r3.z;
    r1.w = frac(r1.w);
    r3.xyzw = float4(0.69374001,0.69374001,0.14,0.14) + r2.zyzy;
    ...
    r2.xyz = frac(r2.xyz);
    r3.xyz = float3(19.19,19.19,19.19) + r2.yzx;
  ...
  if (cb0[58].x > 0) {
    ...
    r2.xyzw = t3.Sample(s1_s, r1.xw).xyzw;
  ...
  if (cb0[50].w > 0) {
    r2.xyz = handleUserLUT(r0.xyz, t5, s5_s, 0.5 / cb0[49].w, 3, true);
    r2.xyz = r2.xyz + -r0.xyz;
  ...
  if (cb0[6].x > 5) {
    ...
    r2.xyzw = t6.Sample(s2_s, r1.yz).xyzw;
