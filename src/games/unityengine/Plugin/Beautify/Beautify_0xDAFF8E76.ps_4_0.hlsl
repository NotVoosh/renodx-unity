  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyzw = t2.SampleBias(s0_s, v1.xy, cb0[4].x).xyzw;
  r3.xyzw = t3.SampleBias(s1_s, v1.xy, cb0[4].x).xyzw;
  r1.y = 0.5 + -cb0[150].z;
  r1.yzw = saturate(r2.xyz * cb0[150].www + r1.yyy);
  r1.yzw = r1.yzw * r3.xyz;
  r0.xyz = r1.yzw * cb0[150].yyy + r0.xyz;
  r1.y = max(r0.y, r0.z);
  r1.y = max(r1.y, r0.x);
  r1.z = min(r0.y, r0.z);
  r1.z = min(r1.z, r0.x);
