  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.x = r3.x + -r2.w;
  r3.z = -r3.y + r2.w;
  r3.z = saturate(cb0[7].w / r3.z);
  if (r2.x > cb0[21].y) {
    r4.xyzw = r1.wzwz + -r1.xyxy;
    r1.xyzw = cb0[21].xxxx * cb0[3].xyxy;
  ...
  r2.xyzw = t2.Sample(s5_s, v1.xy).wxyz;
  r2.yzw = renodx::color::srgb::EncodeSafe(r2.yzw);
  if (cb0[20].z < cb0[3].z) {
    r3.xyzw = t1.SampleLevel(s1_s, v2.xy, v2.w).xyzw;
    r3.x = cb1[7].z * r3.x + cb1[7].w;
    r3.x = 1 / r3.x;
    r3.y = -cb0[16].x + r3.x;
    r3.z = r3.x < cb0[16].x ? 1.0 : 0;
    r3.y = -cb0[17].x * r3.z + abs(r3.y);
    r3.y = cb0[16].y * r3.y;
    r3.y = 0.5 * r3.y;
    r3.x = r3.y / r3.x;
    r3.y = cb0[20].z / cb0[3].z;
    r3.z = -r3.x + r2.x;
    r2.x = r3.y * r3.z + r3.x;
  }
  r2.x = saturate(r2.x);
  ...
  r2.xyzw = t3.Sample(s4_s, v1.xy).xyzw;
  r2.xyz = cb0[13].xxx * r2.xyz * injectedData.fxBloom;
  r0.xyz = r0.xyz + r2.xyz;
  r1.xyzw = t4.Sample(s3_s, v1.xy).xyzw;
  r2.xyzw = t5.Sample(s2_s, w1.xy).xyzw;
  r1.w = 0.5 + -cb0[12].z;
  r1.xyz = saturate(r1.xyz * cb0[12].www + r1.www);
  r1.xyz = r1.xyz * r2.xyz;
  r0.xyz = r1.xyz * cb0[12].yyy + r0.xyz;
